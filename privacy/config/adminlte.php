    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'        => 'Rekap Job Order',
                    'url'         => 'admin/laporanrekapjo',
                    'icon'        => 'bar-chart',
                ],
                
                [
                    'text'        => 'Rekap Time Sheet',
                    'url'         => 'admin/laporanrekapts',
                    'icon'        => 'bar-chart',
                ],
                
                [
                    'text'        => 'Rekap Premi Alat',
                    'url'         => 'admin/laporanrekapalat',
                    'icon'        => 'bar-chart',
                ],
