        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#adddetail").attr("href","http://localhost/gui_front_pbm_laravel/admin/insentifhelper/"+no_insentif+"/detail");
                    var print = $("#printjr").attr("href","http://localhost/gui_front_pbm_laravel/admin/insentifhelper/exportpdf?no_insentif="+no_insentif);
                    if(status == 'POSTED') {
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
