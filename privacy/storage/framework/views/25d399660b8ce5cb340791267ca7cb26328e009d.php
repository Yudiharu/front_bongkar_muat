                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('type', ['1' => 'Vendor', '2' => 'Sopir', '3' => 'Pemilik Mobil'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type1','required','onchange'=>"getcoa();"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('hp', null, ['class'=> 'form-control','id'=>'Hp1', 'placeholder'=>'No. HP','autocomplete'=>'off', 'name'=>'hp'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group2">
                                    ...
                                    <?php echo e(Form::select('kode_coa',$Coa->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Coa'])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('type', ['1' => 'Vendor', '2' => 'Sopir', '3' => 'Pemilik Mobil'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type','required'=>'required','onchange'=>"getcoa2();"])); ?>
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_vendor', null, ['class'=> 'form-control','id'=>'Nama','required'=>'required', 'placeholder'=>'Contoh: NAMA VENDOR,CV','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: NAMA VENDOR,CV", 'onkeypress'=>"return pulsar(event,this)",'readonly'])); ?>
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_vendor_po', null, ['class'=> 'form-control','id'=>'Namapo','required'=>'required', 'placeholder'=>'Contoh: CV. NAMA VENDOR','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: CV. NAMA VENDOR",'readonly'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('telp', null, ['class'=> 'form-control','id'=>'Telp','onkeypress'=>"return hanyaAngka(event)"])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="number1" style="display:none;">
                                <?php echo e(Form::text('hp', null, ['class'=> 'form-control','id'=>'Hp', 'name'=>'hp'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group3">
                                ...
                                <?php echo e(Form::select('kode_coa',$Coa->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Coa1'])); ?>
                            ...
                            <div class="form-group5">
                                ...
                                <?php echo e(Form::select('coa',$Coa->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nomorcoa1'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function getcoa(){
            var type = $('#type1').val();
            $.ajax({
                url: '<?php echo route('vendor.getcoa'); ?>',
                type: 'POST',
                data : {
                    'type': type,
                },
                success: function(results) {
                    if(type != '1'){
                        ...
                        document.getElementById("Nomorcoa").required = false;
                    }else{
                        $('.form-group2').hide();
                        $('.form-group4').show();
                        $('#Nomorcoa').val(results.kode_coa).trigger('change');
                        document.getElementById("Coa").required = false;
            ...
            $.ajax({
                ...
                success: function(results) {
                    if(type != '1'){
                        ...
                        document.getElementById("Nomorcoa1").required = false;
                    }else{
                        $('.form-group3').hide();
                        $('.form-group5').show();
                        $('#Nomorcoa1').val(results.kode_coa).trigger('change');
                        document.getElementById("Coa1").required = false;
                        document.getElementById("Nomorcoa1").required = true;
                    }
                }
            });
        }
