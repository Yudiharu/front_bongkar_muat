...
<?php $__env->startSection('title', 'Lokasi Alat'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Lokasi Alat <b><?php echo e($cust->no_asset_alat); ?></b></font>
    </span>
    ...
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                ...
                <?php echo e(Form::hidden('kode_alat',$cust->kode_alat, ['class'=> 'form-control','readonly','id'=>'KodeCust1'])); ?>

                <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'Id1'])); ?>

                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Nomors', 'No Asset Alat:')); ?>

                            <?php echo e(Form::text('noomor', $cust->no_asset_alat, ['class'=> 'form-control','id'=>'Nama1','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Nomors', 'Pilih Lokasi:')); ?>

                            <?php echo e(Form::select('kode_lokasi',$Lokasi->sort(), null,
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Opr', 'Operator:')); ?>

                            <?php echo e(Form::select('kode_operator',$operator->sort(), null,
                            ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','required'=>'required','id'=>'Operator1'])); ?>

                        </div>
                    </div>
                </div> 
                <span class="pull-right"> 
                    <?php echo e(Form::submit('TAMBAH', ['class' => 'btn btn-success btn-sm simpan','id'=>'submit'])); ?>
...
<script>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            columns: [
                ...
                { data: 'operator.nama_operator', name: 'kode_operator' },
    ...
    function formatStatus(n) {
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('alat.store_lokasi'); ?>',
                type:'POST',
                data:formData,
