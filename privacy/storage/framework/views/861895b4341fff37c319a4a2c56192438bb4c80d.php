                    ...
                    <center><kbd>ADD FORM</kbd></center><br>
                        <div class="row">   
                            <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <!-- <button type="button" class="btn btn-primary btn-xs" title="Pilih Partnumber" onclick="editpart()"><i class="fa fa-edit" data-toggle="tooltip"></i></button>  -->
                                ...
                                <!-- <div class="col-md-2">
                                    <div class="form-group">
                                        <?php echo e(Form::label('nomesin', 'No Mesin:')); ?>

                                        <?php echo e(Form::select('nomesin',[], null, ['class'=> 'form-control select2','id'=>'mesin','required'=>'required','style'=>'width: 100%','placeholder' => '','onchange'=>'getharga();'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        var no_pemakaian = $('#nopakai').val();
            ...
            ajax:'http://localhost/gui_inventory_depo_laravel/admin/pemakaiandetail/getDatabyID?id='+no_pemakaian,
