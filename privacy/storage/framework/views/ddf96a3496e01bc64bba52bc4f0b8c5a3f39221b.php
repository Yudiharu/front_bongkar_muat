<?php $__env->startSection('title', 'Trucking Non Container'); ?>
        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-truckingnon')) : ?>
                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addform">
                        <i class="fa fa-plus"></i> New Trucking Non Container</button>
                    <?php endif; // app('laratrust')->can ?>

                    <span class="pull-right">  
                        <font style="font-size: 16px;"><b>TRUCKING NON CONTAINER</b></font>
                    </span>
                </div>
            </div>
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tanggal_truckingnon', 'Tanggal Trucking:')); ?>

                                    <?php echo e(Form::date('tanggal_truckingnon', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_customer',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Customer1','required'=>'required','readonly'])); ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
            ...
            <?php echo Form::open(['id'=>'EDIT']); ?>
                ...
                <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('no_truckingnon', 'No Trucking:')); ?>

                                    <?php echo e(Form::text('no_truckingnon', null, ['class'=> 'form-control','id'=>'Trucking','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggal_truckingnon', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_customer',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Customer','required'=>'required','readonly'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="#" id="addtruckingnon"><button type="button" class="btn btn-info btn-xs add-button" data-toggle="modal" data-target="">ADD <i class="fa fa-plus"></i></button></a>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('add-truckingnon')) : ?>
            <a href="#" id="addtruckingnon2"><button type="button" class="btn btn-info btn-xs add-button2" data-toggle="modal" data-target="">ADD SPB KEMBALI <i class="fa fa-plus"></i></button></a>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('post-truckingnon')) : ?>
            <button type="button" class="btn btn-success btn-xs tombol1" id="button1">POST <i class="fa fa-bullhorn"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('unpost-truckingnon')) : ?>
            ...
            <?php if (app('laratrust')->can('print-truckingnon')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">      
        ...
        $(function() {          
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('truckingnon.data'); ?>',
        ...
        function getdata(){
            ...
            $.ajax({
                url:'<?php echo route('truckingnon.getdata'); ?>',
                type:'POST',
                data : {
                        'id': no_joborder,
                    },
        ...
        function getdata2(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('truckingnon.getdata2'); ?>',
                type:'POST',
                data : {
                        'id': no_joborder,
                    },
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addtruckingnon").attr("href","http://localhost/gui_front_emkl_laravel/admin/truckingnon/"+no_truckingnon+"/detail");
                    var add = $("#addtruckingnon2").attr("href","http://localhost/gui_front_emkl_laravel/admin/truckingnon/"+no_truckingnon+"/detail3");
                    var print = $("#printtruckingnon").attr("href","http://localhost/gui_front_emkl_laravel/admin/truckingnon/export2?no_truckingnon="+no_truckingnon);
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('truckingnon.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_truckingnon
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('truckingnon.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_truckingnon
                            },
            ...
            $('#button3').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('truckingnon.close'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_truckingnon
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('truckingnon.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_truckingnon
                    },
            ...
            $('#button6').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('truckingnon.showdetailspbnc'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_truckingnon
                    },
            ...
            $('#edittruckingnon').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('truckingnon.edit_truckingnon'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_truckingnon
                    },
            ...
            $('#hapustruckingnon').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('truckingnon.hapus_truckingnon'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_truckingnon
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('truckingnon.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('truckingnon.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
