        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var add = $("#addjo").attr("href","http://localhost/gui_front_depo_laravel/admin/joborder/"+no_joborder+"/detail");
                    var print = $("#printjr").attr("href","http://localhost/gui_front_depo_laravel/admin/joborder/exportpdf?no_joborder="+no_joborder);
