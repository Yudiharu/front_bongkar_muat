                        ...
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs" disabled="true" title="Detail JOR" onclick="getjor()" id='submit3'><i class="fa fa-plus"></i> Detail Job Request</button>
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_seal',null, ['class'=> 'form-control','id'=>'seal2','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('muatan',null, ['class'=> 'form-control','id'=>'muatan2','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('colie',null, ['class'=> 'form-control','id'=>'colie2','required'])); ?>
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addtrucking").attr("href","http://localhost/gui_front_emkl_laravel/admin/trucking/"+no_spb+no_trucking+"/detail4");
