...
<?php $__env->startSection('content_header'); ?>
    ...
    <button type="button" class="btn btn-primary btn-xs" onclick="selisih()"><i class="fa fa-edit"></i> Hitung Selisih</button>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_produk',$Produk, null,
                                         ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Pilih','id'=>'Produk1','onchange'=>'satuan_produk();'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('hpp', null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Harga','id'=>'HPP1'])); ?>
                        ...
                        <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('hpp', null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Harga','id'=>'Harga'])); ?>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty_checker1', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'QTY1'])); ?>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty_checker2', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'QTY2'])); ?>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty_checker3', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'QTY3'])); ?>
...
<script>
        ...
        console.log(no_opname);
            ...
            ajax:'http://localhost/inventory_baru/admin/opnamedetail/getDatabyID?id='+no_opname,
