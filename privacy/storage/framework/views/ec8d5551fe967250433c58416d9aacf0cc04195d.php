...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Pemilik <b><?php echo e($vendor->nama_vendor); ?></b></font>
    </span>
            ...
            <div class="addform">
                    ...
                    <?php echo Form::open(['id'=>'ADD_DETAIL']); ?>
                      ...
                      <center><kbd>ADD FORM</kbd></center><br>
                        <div class="row">
                                <?php echo e(Form::hidden('kode_pemilik',$vendor->id, ['class'=> 'form-control','readonly','id'=>'kodepemilik'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_pemilik',$vendor->nama_vendor, ['class'=> 'form-control','readonly','id'=>'namapemilik'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/pemilikdetail/getDatabyID?id='+kode_pemilik,
