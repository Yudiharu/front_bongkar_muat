...
<?php $__env->startSection('title', 'Premi Operator Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> No Premi <b><?php echo e($insentif->no_insentif); ?></b></font>
    </span>
...
<body onLoad="load()">
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <?php echo e(Form::hidden('no_insentif', $insentif->no_insentif, ['class'=> 'form-control','id'=>'NoInsentif1','readonly'])); ?>

            <?php echo e(Form::hidden('kode_operator', $insentif->kode_operator, ['class'=> 'form-control','id'=>'KodeOp1','readonly'])); ?>

                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('nomors', 'Nama Operator:')); ?>

                            <?php echo e(Form::text('operator',$Operator->nama_operator, ['class'=> 'form-control','readonly','id'=>'Nama1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('qtys', 'Tgl Pakai Dari:')); ?>

                            <?php echo e(Form::text('tgl_pakai_dari', $insentif->tgl_pakai_dari, ['class'=> 'form-control','id'=>'TglDari1','readonly','autocomplete'=>'off'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('qtys', 'Tgl Pakai Sampai:')); ?>

                            <?php echo e(Form::text('tgl_pakai_sampai', $insentif->tgl_pakai_sampai, ['class'=> 'form-control','id'=>'TglSampai1','readonly','autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        function getpakai()
        {
            ...
            var tglsampai = $('#TglSampai1').val();
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('insentifoperatordetail.getpakai'); ?>',
                            type: 'POST',
                            data : {
        ...
        function hapus() {
            ...
            if (e.value === true) {
                $.ajax({
                    url:'<?php echo route('insentifoperatordetail.hapusall'); ?>',
                    type:'POST',
                    data : {
                            'id': no_insentif
                        },
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/insentifoperatordetail/getDatabyID?id='+no_insentif,
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    $('.edit-button').hide();
                    $.ajax({
                        url: '<?php echo route('insentifoperatordetail.show_alat'); ?>',
                        type: 'POST',
                        data : {
                            'id': id,
                        },
            ...
            $('#hapusinsentif').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('insentifoperatordetail.hapusdetail'); ?>',
                            type: 'POST',
                            data : {
                                'no_ts': no_ts
                            },
