                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_asset_alat', null, ['class'=> 'form-control','id'=>'Asset', 'autocomplete'=>'off','readonly','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 15 Karakter", 'maxlength'=>'15', 'onkeypress'=>"return pulsar(event,this)"])); ?>
        ...
        $(document).ready(function(){
            ...
            $('#alat-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var kode_alat = select.find('td:eq(0)').text();
                    $('.hapus-button').show();
                    $('.edit-button').show();
