...
<?php $__env->startSection('title', 'Rekap Time Sheet'); ?>
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo Form::open(['route' => ['laporanrekapts.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>

                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <?php echo e(Form::label('tipe', 'Nama Customer:')); ?>

                                        <?php echo e(Form::select('customer', ['KOSONG'=>'-----------------None-------------------','Customer:'=>$Customer->sort()], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Cust1'])); ?>

                                    </div>
                                </div>
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <?php echo e(Form::label('tipe', 'Nama Alat:')); ?>
