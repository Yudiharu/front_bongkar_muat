...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/gudangdetail/getDatabyID2?id='+kode_gudang,
    ...
    <script>
        ...
        function back(){
            ...
            window.location.replace("http://localhost/gui_front_emkl_laravel/admin/gudang/"+kodeshipper+"/detail");
        }
        ...
        function cancel_edit(){
            ...
            var add = $("#canceltarif").attr("href","http://localhost/gui_front_emkl_laravel/admin/gudang/"+kode_shipper+"/detail");
        }
