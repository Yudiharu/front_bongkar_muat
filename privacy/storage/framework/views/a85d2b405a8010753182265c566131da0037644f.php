<?php $__env->startSection('title', 'FRONT SYSTEM GUI'); ?>
...
<body onLoad="load()">
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title" style="font-size: 25px"><marquee><b><i><font style="color: silver; text-shadow: 0 0 10px #FBBC5C, 0 0 70px #9856f5, 0 0 30px #9856f5, 0 0 40px #9856f5, 0 0 50px #FBBC5C, 0 0 60px #FBBC5C, 0 0 70px #FBBC5C;"><?php echo e($nama_company); ?></font></i></b></marquee></h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <?php if (app('laratrust')->can('read-pemakaianalatberat')) : ?>
        <div class="col-md-3">
      ...
      <div class="row">
          <?php if (app('laratrust')->can('read-premioperator')) : ?>
          <div class="col-md-2">
          ...
          <?php if (app('laratrust')->can('read-premihelper')) : ?>
          <div class="col-md-2">
