                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('kode_satuan', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Satuan','required'=>'required','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 6 Karakter", 'maxlength'=>'6', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_satuan', null, ['class'=> 'form-control','id'=>'Nama2','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
