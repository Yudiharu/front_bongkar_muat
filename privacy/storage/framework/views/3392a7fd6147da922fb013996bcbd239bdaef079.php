...
<body onLoad="load()">
            ...
            <div class="modal-content">
                ...
                <div class="box-body"> 
                    <div class="addform">
                        ...
                        <!-- <div class="col-md-2">
                            <div class="form-group">
                                <?php echo e(Form::label('Tipe Hitung', 'Tipe Hitungan:')); ?>

                                <?php echo e(Form::select('tipe_hitungan', ['1'=>'Per Jam','3'=>'Per Ton'], null, ['class'=> 'form-control select2', 'style'=>'width: 100%','placeholder'=>'','id'=>'Hitungan1','required'=>'required'])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <button type="button" class="btn bg-purple btn-xs premi2-button" id="addpremibutton2" data-toggle="modal" data-target="#addpremi2"><i class="fa fa-plus"></i> ADD PREMI HELPER</button>

            <button type="button" class="btn btn-info btn-xs premi-button" id="addpremibutton" data-toggle="modal" data-target="#addpremi"><i class="fa fa-plus"></i> ADD PREMI OPERATOR</button>
    ...
    <script type="text/javascript">
        ...
        Table2 = $("#addpremi-table").DataTable({
            ...
            columns: [
                ...
                { data: 'premi_jam_nontranshipment', name: 'premi_jam_nontranshipment' },
                { data: 'premi_jam_transhipment', name: 'premi_jam_transhipment' },
                { data: 'premi_opr_tembak', name: 'premi_opr_tembak' },
        ...
        Table3 = $("#addpremi2-table").DataTable({
            ...
            columns: [
                { data: 'id', name: 'id', visible: false },
                { data: 'tgl_berlaku', name: 'tgl_berlaku' },
                { data: 'premi_harian_dk', name: 'premi_harian_dk' },
                { data: 'premi_harian_lk', name: 'premi_harian_lk' },
                { data: 'hari_libur', name: 'hari_libur' },
            ],
        });
