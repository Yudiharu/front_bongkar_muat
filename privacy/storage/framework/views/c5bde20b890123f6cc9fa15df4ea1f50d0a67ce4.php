            ...
            <div class="addform">
                    ...
                    <?php echo Form::open(['id'=>'ADD_DETAIL']); ?>
                      ...
                      <center><kbd>ADD FORM</kbd></center><br>
                            <div class="row">
                                <?php echo e(Form::hidden('kode_shipper',$gudang->kode_shipper, ['class'=> 'form-control','readonly','id'=>'kodeshipper'])); ?>
                ...
                <?php echo Form::open(['id'=>'UPDATE_DETAIL']); ?>
                    ...
                    <center><kbd>EDIT FORM</kbd></center><br>
                            <div class="row">   
                                ...
                                <?php echo e(Form::hidden('kode_shipper',$gudang->kode_shipper, ['class'=> 'form-control','readonly','id'=>'kodeshipper2'])); ?>

                                
                                <?php echo e(Form::hidden('kode_gudang',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Nama Gudang','required'=>'required','id'=>'kodegudang2','readonly'])); ?>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_customer',$gudang->customer->nama_customer, ['class'=> 'form-control','readonly','id'=>'namacust'])); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="box-body"> 
            <div class="addform">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'ADD_TARIF']); ?>

                    <?php echo e(Form::hidden('kode_gudang',null, ['class'=> 'form-control','readonly','id'=>'kodegudang4'])); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_gudang',null,['class'=> 'form-control','style'=>'width: 100%','id'=>'namagudang4', 'readonly'])); ?>

                        </div>
                    </div>

                    <?php echo e(Form::hidden('kode_shipper',null, ['class'=> 'form-control','readonly','id'=>'kodeshipper4'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_shipper',$gudang->customer->nama_customer, ['class'=> 'form-control','style'=>'width: 100%','id'=>'namashipper4', 'readonly'])); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tanggal_berlaku',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'tanggal4','required'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('tarif_trucking',0, ['class'=> 'form-control','style'=>'width: 100%','required'=>'required','id'=>'tarif4'])); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        $.ajax({
            url: '<?php echo route('gudangdetail.getDatatarif'); ?>',
            type: 'GET',
            data : {
                'id': kode
            },
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/gudangdetail/getDatabyID?id='+kode_shipper,
    ...
    <script>
        ...
        function edit_tarif(){
            ...
            var add = $("#viewtarif").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/gudang/"+kode_gudang+kode_shipper+"/detail2");
        }
