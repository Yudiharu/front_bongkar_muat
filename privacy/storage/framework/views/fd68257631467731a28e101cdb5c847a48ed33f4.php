    ...
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            <tr >
                ...
                <td><?php echo e($cashbankin->no_cashbank_in); ?></td>
            </tr>
            <tr>
                <td >No. Reff</td>
                <td>:</td>
                <td><?php echo e($cashbankin->no_reff); ?></td>
            </tr>
            <tr>
                <td >Terima Dari</td>
                <td>:</td>
                <td><?php echo e($cashbankin->terima_dari); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
...
<div class="content">
    ...
    <div class="left">
        <table style="padding-left:0mm; font-size:10pt">
            ...
            <?php foreach ($cashbankindetail as $key => $value): ?>
                <tr >
...
<?php
$grand_total = $cashbankin->grand_total;
?>
