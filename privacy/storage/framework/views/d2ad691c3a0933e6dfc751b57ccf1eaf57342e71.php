        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#adddetail").attr("href","https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/insentifhelper/"+no_insentif+"/detail");
                    var print = $("#printjr").attr("href","https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/insentifhelper/exportpdf?no_insentif="+no_insentif);
                    if(status == 'POSTED') {
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
