...
<head>
    ...
    <meta charset="UTF-8">
    <title>Cetak SPB dengan No JO - <?php echo e($get_jo); ?></title>
    <style>
        @page  {
    ...
    <div class="right">
        <table width="41.5%" style="font-size: 11pt; text-align:right; padding-right:11mm;" border="0">
            <tr>
                ...
                <td style="text-align:left"><?php echo e($data[$i]['no_spb']); ?></td>
            </tr>
            <tr>
                <td>Kepada</td>
                <td style="text-align:left"><?php echo e($data[$i]['gudang']); ?></td>
            </tr>
        </table>
    </div>
</div>
...
<div class="title">
    ...
    <div class="left">
        <table width="71%" style="font-size: 11pt" border="0">
            <tr>
                ...
                <td><?php echo e($trucking->kapal->nama_kapal); ?></td>
            </tr>
            <tr>
                <td>Voyage</td>
                <td><?php echo e($trucking->voyage); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="right">
        <table width="30.5%" style="font-size: 11pt" border="0">
            <tr>
                ...
                <td><?php echo e($trucking->no_joborder); ?></td>
            </tr>
            <tr>
                <td>Truck</td>
            </tr>
    ...
    <div class="content">
        ...
        <table class="grid" style="font-size: 16pt; width: 19cm;" border="0" >
            <tr>
                <td height="10%" style="font-family: Arial;"><?php echo e($data[$i]['container']); ?><br>(<?php echo e($data[$i]['kode_size']); ?>)</td>
                <td height="10%"></td>
                <td height="10%"></td>
            </tr>
        </table>
