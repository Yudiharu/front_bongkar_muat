...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-nonstock')) : ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-nonstock')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-nonstock')) : ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#editnonstock').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('nonstock.edit_nonstock'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_produk
                    },
            ...
            $('#hapusnonstock').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('nonstock.hapus_nonstock'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_produk
                            },
