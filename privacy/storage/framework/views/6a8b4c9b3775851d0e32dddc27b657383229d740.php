        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addtruckingnon").attr("href","http://localhost/gui_front_pbm_laravel/admin/truckingnon/"+no_truckingnon+"/detail");
                    var print = $("#printtruckingnon").attr("href","http://localhost/gui_front_pbm_laravel/admin/truckingnon/export2?no_truckingnon="+no_truckingnon);
