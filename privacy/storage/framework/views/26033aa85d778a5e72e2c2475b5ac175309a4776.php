        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addtransferin").attr("href","http://localhost/gui_inventory_sub_laravel/admin/transferin/"+no_transfer+"/detail");
                    var print = $("#printtransferin").attr("href","http://localhost/gui_inventory_sub_laravel/admin/transferin/cetakPDF?no_transferin="+no_transfer);
                    var status = colom;
                    var item = colom2;
