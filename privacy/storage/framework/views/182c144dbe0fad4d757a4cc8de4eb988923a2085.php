    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="<?php echo e(url(config('adminlte.login_url', 'login'))); ?>" method="post">
                ...
                <input type="hidden" id="kode_company" name="kode_company" value="<?php echo e($Company); ?>">
                <div class="form-group has-feedback <?php echo e($errors->has('username') ? 'has-error' : ''); ?>">
                    <input type="text" name="nama_company" class="form-control" value="<?php echo e($nama_company->nama_company); ?>" readonly>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <a href="http://localhost/gui_inventory_sub_laravel/start"><?php echo e(trans('adminlte::adminlte.remember_me')); ?></a>
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
