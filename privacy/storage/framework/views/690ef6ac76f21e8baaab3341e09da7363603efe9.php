        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpembelian").attr("href","http://localhost/gui_inventory_sub_laravel/admin/pembelian/"+no_pembelian+"/detail");
                    var print = $("#printpembelian").attr("href","http://localhost/gui_inventory_sub_laravel/admin/pembelian/exportpdf?no_pembelian="+no_pembelian);
                    var status = colom;
                    var item = colom2;
