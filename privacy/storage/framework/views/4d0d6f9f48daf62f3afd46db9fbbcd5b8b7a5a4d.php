            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <?php echo e(Form::hidden('limit_dari', 0, ['class'=> 'form-control','id'=>'dari1','required'=>'required', 'placeholder'=>'Limit Dari', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>


                            <?php echo e(Form::hidden('limit_sampai', 0, ['class'=> 'form-control','id'=>'sampai1','required'=>'required', 'placeholder'=>'Limit Sampai', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?php echo e(Form::hidden('kode_signature', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('mengetahui', null, ['class'=> 'form-control','id'=>'Mengetahui', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('jabatan', null, ['class'=> 'form-control','id'=>'Jabatan', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>

                        </div>
                    </div>
                    
                    <?php echo e(Form::hidden('limit_dari', null, ['class'=> 'form-control','id'=>'dari','required'=>'required', 'placeholder'=>'Limit Dari', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>

                            
                    <?php echo e(Form::hidden('limit_sampai', null, ['class'=> 'form-control','id'=>'sampai','required'=>'required', 'placeholder'=>'Limit Sampai', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>
