...
<?php $__env->startSection('title', 'Premi Helper'); ?>
        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-premihelper')) : ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tgl Transaksi:')); ?>

                            <?php echo e(Form::date('tgl_insentif', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('TipeHelper', 'Type Helper:')); ?>

                            <?php echo e(Form::select('type_helper', ['1' => 'Helper 1','2'=>'Helper 2'], null, ['class'=> 'form-control select2','id'=>'Type1', 'style'=>'width: 100%', 'placeholder'=>'','autocomplete'=>'off','required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('NamaHelper', 'Nama Helper:')); ?>

                            <?php echo e(Form::select('kode_helper', $Helper->sort(), null, ['class'=> 'form-control select2','id'=>'NamaHelper1', 'placeholder'=>'','style'=>'width: 100%', 'autocomplete'=>'off','required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggaldr', 'Tgl Pakai Dari:')); ?>

                            <?php echo e(Form::date('tgl_pakai_dari', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggaldr1' ,'required'=>'required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggalsp', 'Tgl Pakai Sampai:')); ?>

                            <?php echo e(Form::date('tgl_pakai_sampai', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggalsp1' ,'required'=>'required'])); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('keterangan',null, ['class'=> 'form-control','id'=>'Ket1','rows'=>'3','required','autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
...
<div class="modal fade" id="editform" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                <?php echo e(Form::hidden('no_insentif', null, ['class'=> 'form-control','id'=>'NoInsentif2','readonly'])); ?>

                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tgl Transaksi:')); ?>

                            <?php echo e(Form::date('tgl_insentif', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal2' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type_helper', ['1' => 'Helper 1','2'=>'Helper 2'], null, ['class'=> 'form-control select2','id'=>'Type2', 'style'=>'width: 100%', 'placeholder'=>'','autocomplete'=>'off','required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kode_helper', $Helper->sort(), null, ['class'=> 'form-control select2','id'=>'NamaHelper2', 'placeholder'=>'','style'=>'width: 100%', 'autocomplete'=>'off','required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tgl_pakai_dari', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggaldr2' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tgl_pakai_sampai', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggalsp2' ,'required'=>'required'])); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('keterangan',null, ['class'=> 'form-control','id'=>'Ket2','rows'=>'3','required','autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
      ...
      <!--<button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>-->
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-premihelper')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-premihelper')) : ?>
            ...
            <?php if (app('laratrust')->can('add-premihelper')) : ?>
            ...
            <?php if (app('laratrust')->can('print-premihelper')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            "pageLength":100,
            "order": [[0, "desc"]],
            ajax: '<?php echo route('insentifhelper.data'); ?>',
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('insentifhelper.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_insentif
                        },
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('insentifhelper.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_joborder
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('insentifhelper.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_joborder
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('insentifhelper.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_insentif
                    },
            ...
            $('#editinsentif').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('insentifhelper.edit_insentif'); ?>',
                    type: 'POST',
                    data : {
            ...
            $('#hapusinsentif').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('insentifhelper.hapus_insentif'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_insentif
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('insentifhelper.store'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('insentifhelper.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
