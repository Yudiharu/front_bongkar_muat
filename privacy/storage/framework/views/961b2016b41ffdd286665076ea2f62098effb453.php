...
<?php $__env->startSection('title', 'Hasil Bagi Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Hasil Bagi <b><?php echo e($hasilbagi->no_hasilbagi); ?></b></font>
    </span>
                        ...
                        <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group1">
                                        ...
                                        <?php echo e(Form::text('no_hasilbagi',$hasilbagi->no_hasilbagi, ['class'=> 'form-control','readonly','id'=>'nohasilbagi'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::hidden('kode_sopir',$hasilbagi->kode_sopir, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'kode_sopir','required','readonly'])); ?>

                                        
                                        <?php echo e(Form::text('nama_sopir',$nama_sopir, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'nama_sopir','required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('spb_dari',$hasilbagi->spb_dari,['class'=> 'form-control','id'=>'dari' ,'required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('spb_sampai',$hasilbagi->spb_sampai,['class'=> 'form-control','id'=>'sampai' ,'required','readonly'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/hasilbagidetail/getDatabyID?id='+no_hasilbagi,
        ...
        $(document).ready(function() {
            ...
            $('#hapushasilbagi').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('hasilbagidetail.hapus_hasilbagi'); ?>',
                            type: 'POST',
                            data : {
        ...
        function getspb()
        {
            ...
            var sampai = $('#sampai').val();
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('hasilbagidetail.getspb'); ?>',
                            type: 'POST',
                            data : {
                                'no_hasilbagi': no_hasilbagi,
    ...
    <script>
        ...
        function hapus() {
            ...
            if (e.value === true) {
                $.ajax({
                    url:'<?php echo route('hasilbagidetail.hapusall'); ?>',
                    type:'POST',
                    data : {
                            'id': no_hasilbagi
                        },
