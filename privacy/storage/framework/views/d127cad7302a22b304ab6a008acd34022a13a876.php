                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama customer', 'Deskripsi:')); ?>

                            <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Desc1','required'=>'required', 'placeholder'=>'Nama Kegiatan','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>

                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('alamat', 'COA:')); ?>

                            <?php echo e(Form::select('kode_coa', $Coa->sort(), null, ['class'=> 'form-control select2','id'=>'Coa1', 'placeholder'=>'','style'=>'width: 100%'])); ?>

                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('alamat', 'Tipe Kegiatan:')); ?><br>
                    ...
                    <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Desc2','required'=>'required', 'placeholder'=>'Nama Kegiatan','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('kode_coa', $Coa->sort(), null, ['class'=> 'form-control select2','id'=>'Coa2', 'placeholder'=>'','style'=>'width: 100%'])); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo route('kegiatan.data'); ?>',
                columns: [
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addtarif").attr("href","http://localhost/gui_front_depo_laravel/admin/kegiatan/"+id_kegiatan+"/detail");
                    $('.hapus-button').show();
                    $('.edit-button').show();
                    $('.add-button').show();
                }
            ...
            $('#editkegiatan').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('kegiatan.edit_kegiatan'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#hapuskegiatan').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('kegiatan.hapus_kegiatan'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('kegiatan.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('kegiatan.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
