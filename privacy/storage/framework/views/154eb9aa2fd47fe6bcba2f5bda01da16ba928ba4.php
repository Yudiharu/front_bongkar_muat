<?php $__env->startSection('title', 'Add Penyelesaian'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Penyelesaian No. JO <b><?php echo e($joborder->no_joborder); ?></b></font>
    </span>
...
<body onLoad="load()">
    <div class="box box-danger">
        <div class="box-body"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_cbo',null, ['class'=> 'form-control','id'=>'nocbo1','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nilai',null, ['class'=> 'form-control','id'=>'nilai1','required'])); ?>
            ...
            <div class="editform">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'UPDATE_PENYELESAIAN']); ?>
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_cbo',null, ['class'=> 'form-control','id'=>'nocbo2'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tgl_cbo', \Carbon\Carbon::now(), ['class'=> 'form-control','id'=>'tglcbo2','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nilai',null, ['class'=> 'form-control','id'=>'nilai2','required'])); ?>
   ...
   <div class="box box-danger">
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <button type="button" class="btn btn-warning btn-xs edit-button" id="editpenyelesaian" data-toggle="modal" data-target="">EDIT <i class="fa fa-edit"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('delete-jo')) : ?>
            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapuspenyelesaian" data-toggle="modal" data-target="">HAPUS <i class="fa fa-times-circle"></i></button>
            <?php endif; // app('laratrust')->can ?>
        </div>
</body>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/joborderdetail/getDatabyIDpenyelesaian?id='+no_joborder,
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var no_cbo = select.find('td:eq(1)').text();
            ...
            $('#editpenyelesaian').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('joborderdetail.edit_penyelesaian'); ?>',
                    type: 'POST',
                    data : {
                        'no_cbo': no_cbo,
                    },
                    success: function(results) {
                        ...
                        $('#nocbo2').val(results.no_cbo);
                        $('#tglcbo2').val(results.tgl_cbo);
            ...
            $('#hapuspenyelesaian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('joborderdetail.hapus_penyelesaian'); ?>',
                            type: 'POST',
                            data : {
                                'no_cbo': no_cbo,
                            },
    ...
    <script>
        ...
        $('#ADD_PENYELESAIAN').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('joborderdetail.storepenyelesaian'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#UPDATE_PENYELESAIAN').submit(function (e) {
            swal({
                    title: "<b>Proses Sedang Berlangsung</b>",
                    type: "warning",
                    showCancelButton: false,
            ...
            var registerForm = $("#UPDATE_PENYELESAIAN");
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('joborderdetail.updateajaxpenyelesaian'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        if(data.success === true) {
