                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_transaksi', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Transaksi','required'=>'required','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_transaksi', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Transaksi','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#edittransaksisetup').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('transaksisetup.edit_transaksisetup'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_setup
                    },
            ...
            $('#hapustransaksisetup').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('transaksisetup.hapus_transaksisetup'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_setup
                            },
