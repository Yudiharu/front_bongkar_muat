...
<body onLoad="load()"> 
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-lokasi')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_lokasi', null, ['class'=> 'form-control','id'=>'id1', 'placeholder'=>'ID Lokasi','required'=>'required','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 6 Karakter", 'maxlength'=>'6', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo e(Form::label('Alamat', 'Alamat:')); ?>
                                    ...
                                    <?php echo e(Form::textArea('alamat', null, ['class'=> 'form-control','rows'=>4,'id'=>'Alamat2','required'=>'required','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-lokasi')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-lokasi')) : ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#editlokasi').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('masterlokasi.edit_lokasi'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_lokasi
                    },
            ...
            $('#hapuslokasi').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('masterlokasi.hapus_lokasi'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_lokasi
                            },
