...
<?php $__env->startSection('title', 'Rekap SPB/Tgl Kembali SPB'); ?>
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo Form::open(['route' => ['laporanrekap_pertgl.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <?php echo e(Form::label('tanggal_awal', 'SPB Kembali Dari:')); ?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <?php echo e(Form::label('tanggal_akhir', 'SPB Kembali Sampai:')); ?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <?php echo e(Form::label('type', 'Type SPB:')); ?>

                                            <?php echo e(Form::select('type', ['Container' => 'Container', 'Non-Container' => 'Non-Container'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type1','required'=>'required'])); ?>
