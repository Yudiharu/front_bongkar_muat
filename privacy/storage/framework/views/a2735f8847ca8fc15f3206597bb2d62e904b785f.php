                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('mob_demob',null, ['class'=> 'form-control','id'=>'Mob1','autocomplete'=>'off'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('qty',null, ['class'=> 'form-control','id'=>'Qty2','required','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('mob_demob',null, ['class'=> 'form-control','id'=>'Mob2','autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/joborderdetail/getDatabyID?id='+no_joborder,
