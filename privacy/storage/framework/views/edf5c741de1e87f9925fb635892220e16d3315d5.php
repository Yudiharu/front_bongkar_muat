...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        function tarif(){
            ...
            var total = 0;
            $.ajax({
                url:'<?php echo route('jobrequestdetail.tarif'); ?>',
                type:'POST',
                data : {
                    'kode': kode,
                    'no_joborder': no_jo,
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/jobrequestdetail/getDatabyID?id='+no_joborder,
