            ...
            <div class="box ">
                <div class="box-body">
                    ...
                    <span class="pull-right">
                        ...
                        <font style="background-color:#F3E61D;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>&nbsp;:&nbsp;Asosiasi/Member.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <?php echo e(Form::label('Email', 'Alamat E-mail:')); ?>

                                    <?php echo e(Form::text('email', null, ['class'=> 'form-control','id'=>'Email1', 'placeholder'=>'email@app.com','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom"])); ?>
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('jenis_harga', $Jenis, null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'tipe2', 'required'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('email', null, ['class'=> 'form-control','id'=>'Email', 'placeholder'=>'email@app.com','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom"])); ?>
        ...
        $(function() {         
            $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'alamat2', name: 'alamat2' },
                    { data: 'jenis_harga', name: 'jenis_harga', visible: false },
                    { data: 'telp', name: 'telp' },
                    { data: 'fax', name: 'fax' },
                    { data: 'hp', name: 'hp' },
