...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-catatanpo')) : ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-catatanpo')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-catatanpo')) : ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#editcatatanpo').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('catatanpo.edit_catatanpo'); ?>',
                    type: 'POST',
                    data : {
                        'id': nomor
                    },
            ...
            $('#hapuscatatanpo').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('catatanpo.hapus_catatanpo'); ?>',
                            type: 'POST',
                            data : {
                                'id': nomor
                            },
