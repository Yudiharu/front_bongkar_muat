                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group19">
                                    ...
                                    <?php echo e(Form::select('pilih', ['Internal' => 'Internal'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'pilih','required'=>'required','onchange'=>"get();"])); ?>

                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group1">
                                    <?php echo e(Form::label('kepemilikan', 'Kepemilikan:')); ?>

                                    <?php echo e(Form::text('kepemilikan', $nama_company, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'kepemilikan','required','readonly'])); ?>

                                </div>

                                <div class="form-group2">
                                    <?php echo e(Form::label('kode_vendor', 'Pilih Vendor:')); ?>

                                    <?php echo e(Form::select('kode_vendor',$Vendor,null, ['class'=> 'form-control select2','id'=>'vendor','style'=>'width: 100%','placeholder' => ''])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group17">
                                    ...
                                    <?php echo e(Form::select('kode_jenis_mobil', $JenisMobil, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Jenis1'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group16">
                                    ...
                                    <?php echo e(Form::selectYear('tahun', 2000, 2045, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nama4', 'autocomplete'=>''])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group15">
                                    ...
                                    <?php echo e(Form::text('no_asset_mobil', null, ['class'=> 'form-control','id'=>'Asset1', 'placeholder'=>'No. Asset','required'=>'required','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                        <?php echo e(Form::label('kir', 'KIR:')); ?>

                                        <?php echo e(Form::date('kir', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'kir'])); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                        <?php echo e(Form::label('masa_stnk', 'Masa STNK:')); ?>

                                        <?php echo e(Form::date('masa_stnk', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'stnk'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group14">
                                    <br>
                                    <?php echo e(Form::label('status_mobil', 'Status:')); ?>

                                    <?php echo e(Form::select('status_mobil', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'stat'])); ?>
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nopol', null, ['class'=> 'form-control','id'=>'Nopol','required'=>'required','autocomplete'=>'off','readonly'])); ?>

                                </div>
                            </div>
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('kode_jenis_mobil1', 'Jenis Mobil:')); ?>

                                    <?php echo e(Form::select('kode_jenis_mobil1',$JenisMobil,null, ['class'=> 'form-control','id'=>'Jenis','required'=>'required','style'=>'width: 100%'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_jenis_mobil',null, ['class'=> 'form-control','id'=>'Jenis','readonly','style'=>'width: 100%'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::selectYear('tahun', 2000, 2045, null, ['class'=> 'form-control','id'=>'Tahun2', 'autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset_mobil', null, ['class'=> 'form-control','id'=>'Asset','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'readonly'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('kir', null,['class'=> 'form-control','id'=>'kir2'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('masa_stnk', null,['class'=> 'form-control','id'=>'stnk2'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('status_mobil', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'stat2','required'=>'required'])); ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group3">
                                    ...
                                    <?php echo e(Form::text('kepemilikan', null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'kepemilikan2','required','readonly'])); ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('mobil.getkode'); ?>',
                        type:'POST',
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var addmt = $("#addlokasi").attr("href","https://aplikasi.gui-group.co.id/gui_front_02/admin/mobil/"+kode_mobil+"/detaillokasi");
                    $('.hapus-button').show();
                    $('.edit-button').show();
                    $('.add-button').show();
                }
