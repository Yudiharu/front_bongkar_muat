        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addjo").attr("href","https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/insentifoperator/"+no_insentif+"/detail");
                    var print = $("#printjr").attr("href","https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/insentifoperator/exportpdf?no_insentif="+no_insentif);
                    if(status == 'POSTED'){
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
