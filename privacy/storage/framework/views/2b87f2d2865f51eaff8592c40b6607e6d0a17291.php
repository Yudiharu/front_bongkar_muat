            ...
            columns: [
                ...
                { data: 'no_pembelian', 
                    render: function(data, type, row, meta){
                        if(type === 'display'){
                            data = '<a href="http://localhost/gui_inventory_laravel/admin/pembelian/exportpdf?no_pembelian='+ data +'" target="_blank">' + data + '</a>';
                        }
                        return data;
                    }
                },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpenerimaan").attr("href","http://localhost/gui_inventory_laravel/admin/penerimaan/"+no_penerimaan+"/detail");
                    var print = $("#printpenerimaan").attr("href","http://localhost/gui_inventory_laravel/admin/penerimaan/exportpdf?no_penerimaan="+no_penerimaan);
                    var status = colom;
                    var item = colom2;
