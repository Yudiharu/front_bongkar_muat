                ...
                <?php echo Form::open(['id'=>'UPDATE_DETAIL']); ?>
                    ...
                    <center><kbd>EDIT FORM</kbd></center><br>
                            <div class="row">   
                                ...
                                <?php echo e(Form::hidden('kode_shipper',$trucking->kode_shipper, ['class'=> 'form-control','readonly','id'=>'shipper2'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_shipper',null, ['class'=> 'form-control','readonly','id'=>'namashipper2'])); ?>
                                ...
                                <?php echo e(Form::hidden('kode_size',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','required','readonly','id'=>'kode_size2'])); ?>


                                <div class="col-md-2">
                                    <div class="form-group">
                                        <?php echo e(Form::label('nama_size', 'Nama Size:')); ?>

                                        <?php echo e(Form::text('nama_size',null, ['class'=> 'form-control','readonly','id'=>'namasize2'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group6">
                                        ...
                                        <?php echo e(Form::date('tgl_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Tanggal SPB tidak boleh lebih dari tanggal kembali.",'onchange'=>"gettariftgl();"])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('tarif_trucking',null, ['class'=> 'form-control','readonly','id'=>'tarif2','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('dari',null, ['class'=> 'form-control','id'=>'dari2','required','autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('tujuan',null, ['class'=> 'form-control','id'=>'tujuan2','required','autocomplete'=>'off'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('no_trucking',$trucking->no_trucking, ['class'=> 'form-control','style'=>'width: 100%','id'=>'notruck','required','readonly'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::date('tgl_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal' ,'required'=>'required','onchange'=>"tgl2();",'readonly'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::date('tgl_kembali', null,['class'=> 'form-control','id'=>'Kembali' ,'required'=>'required','onchange'=>"tgl2();"])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('kode_mobil',$Mobil->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Mobil','required'=>'required','onchange'=>"pemilik2();"])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group1">
                                            ...
                                            <?php echo e(Form::select('no_asset_mobil',$Asmobil->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'asset_mobil'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group2">
                                            ...
                                            <?php echo e(Form::select('kode_sopir',$Sopir->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Sopir'])); ?>
                                        ...
                                        <div class="form-group3">
                                            ...
                                            <?php echo e(Form::text('sopir',null, ['class'=> 'form-control','id'=>'Namasopir','autocomplete'=>'off'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('bpa', null, ['class'=> 'form-control','id'=>'Bpa', 'placeholder'=>'BPA', 'autocomplete'=>'off','required','onkeyup'=>"cekbpa2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"B/P/A tidak boleh lebih besar dari tarif trucking dan uang jalan"])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('honor', null, ['class'=> 'form-control','id'=>'Honor', 'placeholder'=>'Honor', 'autocomplete'=>'off','required','onkeyup'=>"cekhonor2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Honor tidak boleh lebih besar dari tarif trucking dan uang jalan"])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('biaya_lain', null, ['class'=> 'form-control','id'=>'Biaya', 'placeholder'=>'Biaya', 'autocomplete'=>'off','required','onkeyup'=>"cekbiaya2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Biaya lain tidak boleh lebih besar dari tarif trucking dan uang jalan"])); ?>
   ...
   <div class="box box-danger">
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('delete-truckingdetail')) : ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        function gettariftgl(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('truckingdetail.gettariftgl'); ?>',
                type:'POST',
                data : {
                        'kode_gudang': kode_gudang,
                        'tgl_spb': tgl_spb,
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/truckingdetail/getDatabyID?id='+no_trucking,
