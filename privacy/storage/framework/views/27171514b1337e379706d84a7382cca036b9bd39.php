...
<body onLoad="panggil()">
                        <!-- <font style="font-size: 14px;">Periode Open: <b><?php echo e($period); ?></b></font> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('jenis_po', ['Stock' => 'Stock','Non-Stock/Jasa' => 'Non-Stock/Jasa'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Jenis1','required'=>'required'])); ?>
