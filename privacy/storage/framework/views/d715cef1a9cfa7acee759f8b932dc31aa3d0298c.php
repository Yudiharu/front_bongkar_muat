                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('type', ['Mobil'=>'Mobil','Alat'=>'Alat','Kapal'=>'Kapal','Other'=>'Other'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type','onchange'=>"pakai();"])); ?>
                    ...
                    <!--  -->
                            <div class="modal-body">
                                <div class="row">                                
                                    ...
                                    <!-- <div class="form-group_e1 col-md-6">
                                        <div id="nopols">
                                            <?php echo e(Form::label('nopol', 'Nomor Polisi:')); ?>

                                            <?php echo e(Form::select('kode_mobil',$Mobil,null, ['class'=>'form-control select2','id'=>'Nopol1_e','style'=>'width: 100%','placeholder' => '','disabled','onchange'=>'getasetmobil();'])); ?>

                                        </div>             
                                    </div>

                                    <div class="form-group_e2 col-md-6">                     
                                        <div id="alats">
                                            <?php echo e(Form::label('kode_alat', 'Kode Alat:')); ?>

                                            <?php echo e(Form::select('kode_alat',$Alat,null, ['class'=>'form-control select2','id'=>'Alat1_e','style'=>'width: 100%','placeholder' => '','disabled','onchange'=>'getasetalat();'])); ?>

                                        </div>
                                    </div>

                                    <div class="form-group_e5 col-md-6">
                                        <div id="kapals">
                                            <?php echo e(Form::label('kode_kapal', 'Kode Kapal:')); ?>

                                            <?php echo e(Form::select('kode_kapal',$Kapal,null, ['class'=>'form-control select2','id'=>'Kapal1_e','style'=>'width: 100%','placeholder' => '','disabled','onchange'=>'getasetkapal();'])); ?>

                                        </div>
                                    </div>   

                                    <div class="form-group_e4 col-md-6">
                                        <div id="noasetx1">
                                            <?php echo e(Form::label('Aset', 'No Aset Mobil:')); ?>

                                            <?php echo e(Form::select('aset',$Asmobil, null, ['class'=> 'form-control select2','id'=>'noaset1_e','style'=>'width: 100%','placeholder' => ''])); ?>

                                        </div>
                                    </div>

                                    <div class="form-group_e8 col-md-6">
                                        <div id="noasetx2">
                                            <?php echo e(Form::label('Aset', 'No Aset Alat:')); ?>

                                            <?php echo e(Form::select('aset',$Asalat, null, ['class'=> 'form-control select2','id'=>'noaset2_e','style'=>'width: 100%','placeholder' => ''])); ?>

                                        </div>
                                    </div>

                                    <div class="form-group_e9 col-md-6">
                                        <div id="noasetx3">
                                            <?php echo e(Form::label('Aset', 'No Aset Kapal:')); ?>

                                            <?php echo e(Form::select('aset',$Askapal, null, ['class'=> 'form-control select2','id'=>'noaset3_e','style'=>'width: 100%','placeholder' => ''])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            columns: [
                ...
                { data: 'kapal.nama_kapal', name: 'nama_kapal',defaultContent:''},
 ...
 //FUNGSI BREAKDOWN
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var print = $("#button3").attr("href","http://localhost/inventory_baru/admin/pemakaian/cetakPDF?id="+no_pemakaian);
        ...
        $('#ADD').submit(function (e) {
            ...
            var asset = $.trim($('#noaset1').val());
            var asset2 = $.trim($('#noaset2').val());
            var asset3 = $.trim($('#noaset3').val());            
            var kapal = $.trim($('#Kapal1').val());
        ...
        $('#EDIT').submit(function (e) {
            ...
            var Asetmobil = $.trim($('Asetmobil').val());
            var alat = $.trim($('#Alat').val());
            var Asetalat = $.trim($('Asetalat').val());
            var kapal = $.trim($('#Kapal').val());
            var Asetkapal = $.trim($('Asetkapal').val());
