                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('type', ['MV'=>'MV','KM'=>'KM','Tug Boat'=>'Tug Boat','Tongkang'=>'Tongkang'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nama3'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type', ['MV'=>'MV','KM'=>'KM'],null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Tipe2'])); ?>
