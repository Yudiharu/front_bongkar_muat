...
<?php $__env->startSection('title', 'Premi Operator'); ?>
        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-premioperator')) : ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tanggal Transaksi:')); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('opertas', 'Nama Operator:')); ?>

                            <?php echo e(Form::select('kode_operator',$Operator->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Operator1','required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tgl Pakai Dari:')); ?>

                            <?php echo e(Form::date('tgl_pakai_dari', null,['class'=> 'form-control','id'=>'TglDari1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tgl Pakai Sampai:')); ?>

                            <?php echo e(Form::date('tgl_pakai_sampai', null,['class'=> 'form-control','id'=>'TglSampai1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="form-group">
                            <?php echo e(Form::label('orders', 'Keterangan:')); ?>

                            <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','id'=>'Keterangan1', 'placeholder'=>'Keterangan', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'rows'=>'2'])); ?>
...
<div class="modal fade" id="editform" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?php echo e(Form::hidden('no_insentif',null, ['class'=> 'form-control','id'=>'Joborder2','readonly'])); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kode_operator',$Operator->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Operator2','required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tgl_pakai_dari', null,['class'=> 'form-control','id'=>'TglDari2'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tgl_pakai_sampai', null,['class'=> 'form-control','id'=>'TglSampai2'])); ?>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','id'=>'Keterangan2', 'placeholder'=>'Keterangan', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'rows'=>'2'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-premioperator')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-premioperator')) : ?>
            ...
            <?php if (app('laratrust')->can('add-premioperator')) : ?>
            ...
            <?php if (app('laratrust')->can('print-premioperator')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            "pageLength":100,
            "order": [[0, "desc"]],
            ajax: '<?php echo route('insentifoperator.data'); ?>',
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('insentifoperator.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_insentif
                        },
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('insentifoperator.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_insentif
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('insentifoperator.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_insentif
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('insentifoperator.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_insentif
                    },
            ...
            $('#editjoborder').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('insentifoperator.edit_insentif'); ?>',
                    type: 'POST',
                    data : {
            ...
            $('#hapusjoborder').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('insentifoperator.hapus_insentif'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_insentif
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('insentifoperator.store'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('insentifoperator.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
