    ...
    <div class="modal-dialog" role="document">
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="#" id="addjor"><button type="button" class="btn btn-info btn-xs add2-button" data-toggle="modal" data-target="">JOB REQUEST <i class="fa fa-plus"></i></button></a>
            <?php endif; // app('laratrust')->can ?>
            ...
            <button type="button" class="btn btn-primary btn-xs viewjor-button" id="button6">VIEW JOBREQUEST <i class="fa fa-eye"></i></button>
            <?php endif; // app('laratrust')->can ?>
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add2 = $("#addjor").attr("href","http://localhost/gui_front_pbm_laravel/admin/joborder/"+no_joborder+"/detail2");
