<?php $__env->startSection('title', 'FRONT SYSTEM DEPO'); ?>
...
<body onLoad="load()">
      ...
      <div class="row">
        ...
        <?php if (app('laratrust')->can('read-pembayaranx')) : ?>
        <div class="col-md-2">
        ...
        <?php if (app('laratrust')->can('read-hasilbagix')) : ?>
        <div class="col-md-2">
        ...
        <?php if (app('laratrust')->can('read-truckingx')) : ?>
        <div class="col-md-2">
        ...
        <?php if (app('laratrust')->can('read-truckingnonx')) : ?>
        <div class="col-md-2">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <tr>
                    ...
                    <td><span class="badge bg-purple">DEPO</span><br></td>
                </tr>
