                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('type', ['1' => 'Vendor', '2' => 'Sopir'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type1','required','onchange'=>"getcoa();"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('norek_vendor', 'No. Rekening:')); ?>

                                    <input type="text" name="number1" style="display:none;">
                                    <?php echo e(Form::text('norek_vendor', null, ['class'=> 'form-control','id'=>'Norek1', 'placeholder'=>'No. Rekening','autocomplete'=>'off', 'name'=>'norek'])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="number1" style="display:none;">
                                <?php echo e(Form::text('norek_vendor', null, ['class'=> 'form-control','id'=>'Norek', 'placeholder'=>'No. Rekening','autocomplete'=>'off', 'name'=>'norek'])); ?>
