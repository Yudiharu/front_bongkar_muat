<?php $__env->startSection('title', 'Rekap SPB/Container'); ?>
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo Form::open(['route' => ['laporanrekap_percontainer.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <?php echo e(Form::select('kode_container',$Container->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Container1','required'=>'required'])); ?>
