                    ...
                    <?php echo Form::open(['id'=>'UPDATE_DETAIL']); ?>
                      ...
                      <center><kbd>EDIT FORM</kbd></center><br>
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <!-- <button type="button" class="btn btn-primary btn-xs" title="Create SPB" onclick="createspbnon()" id='submit3' disabled="true">Create SPB</button> -->
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_spb_manual',null, ['class'=> 'form-control','id'=>'spbmanual','autocomplete'=>'off','autocomplete'=>'off','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tanggal_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tanggal' ,'required'=>'required','onchange'=>"tgl();",'readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_mobil',null, ['class'=> 'form-control','id'=>'kode_mobil','required'=>'required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_sopir',null, ['class'=> 'form-control','id'=>'kode_sopir','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_pemilik', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Kodepemilik1','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('tarif_gajisopir',null, ['class'=> 'form-control','id'=>'gaji','onkeyup'=>"cektarif2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Tarif gaji tidak boleh lebih kecil dari uang jalan dan BBM",'required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('uang_jalan',null, ['class'=> 'form-control','id'=>'uang','onkeyup'=>"cekuang2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Uang Jalan tidak boleh lebih besar dari tarif gaji dan tidak lebih kecil dari BBM",'required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('bbm',null, ['class'=> 'form-control','id'=>'bbm','onkeyup'=>"cekbbm2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"BBM tidak boleh lebih besar dari tarif gaji dan uang jalan",'required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('dari',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'dari','required'=>'required','autocomplete'=>'off','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('tujuan',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'tujuan','required'=>'required','autocomplete'=>'off','readonly'])); ?>
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var no_spb_manual = select.find('td:eq(2)').text();
                    var tanggal_spb = select.find('td:eq(3)').text();
                    var tanggal_kembali = select.find('td:eq(4)').text();
                    var total_berat = select.find('td:eq(5)').text();
                    var kode_mobil = select.find('td:eq(6)').text();
                    var kode_sopir = select.find('td:eq(7)').text();
                    var kode_pemilik = select.find('td:eq(8)').text();
                    var tarif_gajisopir = select.find('td:eq(9)').text();
                    var uang_jalan = select.find('td:eq(10)').text();
                    var bbm = select.find('td:eq(11)').text();
                    var dari = select.find('td:eq(12)').text();
                    var tujuan = select.find('td:eq(13)').text();
                    var add = $("#addspbnc").attr("href","http://localhost/gui_front_emkl_laravel/admin/truckingnon/"+no_spb+no_truckingnon+"/detail2");

                    $.ajax({
                        type: 'POST',
                        url: '<?php echo route('truckingnondetail.getdata'); ?>',
                        data: {
                            'no_truckingnon':no_truckingnon,
                            'no_spb':no_spb,
                        },
                        success: function (results) {
                            ...
                            $('#spbmanual').val(results.no_spb_manual);
                            $('#tanggal').val(results.tanggal_spb);
                            $('#kembali').val(results.tanggal_kembali);
                            $('#berat').val(results.total_berat);
                            $('#Kodepemilik1').val(results.kode_pemilik);
                            $('#kode_mobil').val(results.kode_mobil);
                            $('#kode_sopir').val(results.kode_sopir);
