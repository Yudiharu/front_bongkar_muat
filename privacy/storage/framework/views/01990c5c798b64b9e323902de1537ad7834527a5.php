        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addopname").attr("href","http://localhost/gui_inventory_laravel/admin/opname/"+no_pembelian+"/detail");
                    var print = $("#printopname").attr("href","http://localhost/gui_inventory_laravel/admin/opname/exportpdf?no_opname="+no_pembelian);
                    var status = colom;
                    var item = colom2;
