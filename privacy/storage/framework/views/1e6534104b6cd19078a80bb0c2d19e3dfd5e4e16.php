            ...
            <div class="modal fade" id="editform2" role="dialog">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo Form::open(['id'=>'EDIT_SPB']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_truckingnon',$truckingnon->no_truckingnon, ['class'=> 'form-control','readonly','id'=>'notruckingnon3'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_spb',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'spb3','required','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_spb_manual',null, ['class'=> 'form-control','id'=>'spbmanual3','autocomplete'=>'off','autocomplete'=>'off','required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggal_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tanggal3' ,'required'=>'required','onchange'=>"tgl();",'readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggal_kembali', null,['class'=> 'form-control','id'=>'kembali3' ,'required'=>'required','onchange'=>"tgl();"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('total_berat',0, ['class'=> 'form-control','id'=>'berat3','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_mobil',$Mobil->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'kode_mobil3','required'=>'required','onchange'=>"pemilik();"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group3">
                                    <br>
                                    <?php echo e(Form::label('no_asset_mobil', 'No Asset:')); ?>

                                    <?php echo e(Form::select('no_asset_mobil',$Asmobil->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'asset_mobil3'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group4">
                                    ...
                                    <?php echo e(Form::select('kode_sopir',$Sopir->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'kode_sopir3'])); ?>
                                ...
                                <div class="form-group5">
                                    ...
                                    <?php echo e(Form::text('sopir',null, ['class'=> 'form-control','id'=>'Namasopir3','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group6">
                                    ...
                                    <?php echo e(Form::text('nama_pemilik', null, ['class'=> 'form-control','id'=>'Pemilik3','readonly'])); ?>

                                    <?php echo e(Form::hidden('kode_pemilik', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Kodepemilik3'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group7">
                                    ...
                                    <?php echo e(Form::text('tarif_gajisopir',null, ['class'=> 'form-control','id'=>'gaji3','onkeyup'=>"cektarif2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Tarif gaji tidak boleh lebih kecil dari uang jalan dan BBM",'required','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group8">
                                    ...
                                    <?php echo e(Form::text('uang_jalan',null, ['class'=> 'form-control','id'=>'uang3','onkeyup'=>"cekuang2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Uang Jalan tidak boleh lebih besar dari tarif gaji dan tidak lebih kecil dari BBM",'required','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group9">
                                    ...
                                    <?php echo e(Form::text('bbm',null, ['class'=> 'form-control','id'=>'bbm3','onkeyup'=>"cekbbm2();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"BBM tidak boleh lebih besar dari tarif gaji dan uang jalan",'required','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group10">
                                    ...
                                    <?php echo e(Form::text('dari',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'dari3','required'=>'required','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group11">
                                    ...
                                    <?php echo e(Form::text('tujuan',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'tujuan3','required'=>'required','autocomplete'=>'off'])); ?>
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <?php echo e(Form::submit('Update data', ['class' => 'btn btn-success','id'=>'submit4'])); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="box-body"> 
            <div class="addform">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'ADD_SPB']); ?>

                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo e(Form::label('no_truckingnon', 'No Trck. Non Container:')); ?>

                        <?php echo e(Form::text('no_truckingnon',$no_truckingnon, ['class'=> 'form-control','style'=>'width: 100%','id'=>'notruckingnon','required','readonly'])); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('no_spbnon',null, ['class'=> 'form-control','readonly','id'=>'spbnon','readonly'])); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('kode_item',null, ['class'=> 'form-control','required','id'=>'item','autocomplete'=>'off'])); ?>
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('qty',null, ['class'=> 'form-control','required','id'=>'qty','onkeyup'=>'gettotal()','autocomplete'=>'off'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('berat_satuan',null, ['class'=> 'form-control','required','id'=>'berats','onkeyup'=>'gettotal()','autocomplete'=>'off'])); ?>

                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo e(Form::text('total_berat',null, ['class'=> 'form-control','required','id'=>'total', 'readonly','placeholder'=>'Total Berat'])); ?>

                    </div>
                </div>
                <div class="col-md-7">
                    <div class="form-group">
                        <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'1','id'=>'keterangan', 'placeholder'=>'Keterangan', 'autocomplete'=>'off'])); ?>
   ...
   <div class="box box-danger">
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">   
            ...
            <?php if (app('laratrust')->can('delete-truckingnondetail')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/truckingnondetail/getDatabyID?id='+no_truckingnon,
    ...
    function tablespb(kode){
        $.ajax({
            url: '<?php echo route('truckingnondetail.getDataspb'); ?>',
            type: 'GET',
            data : {
                'id': kode
            },
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addtruckingnon2").attr("href","http://localhost/gui_front_emkl_laravel/admin/truckingnon/"+no_truckingnon+"/detail3");
                    if(item == 0){
                        $('.add-button').show();
                        $('.hapus-button').show();
                        $('.edit-button').show();
            ...
            $('#editspbkembali').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('truckingnondetail.edit_truckingnon2'); ?>',
                    type: 'POST',
                    data : {
                        'no_truckingnon': no_truckingnon,
                        'no_spbnon': no_spbnon,
                    ...
                    success: function(results) {
                        ...
                        $('#Namasopir3').val(results.kode_sopir);
                        $('#Pemilik3').val(results.nama_pemilik);
                        $('#Kodepemilik3').val(results.kode_pemilik);
            ...
            $('#hapusspb').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('truckingnondetail.hapus_spbnon'); ?>',
                            type: 'POST',
                            data : {
                                'no_spbnon': no_spbnon,
                                'kode_item': kode_item,
            ...
            $('#editspb').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('truckingnondetail.edit_spbnon'); ?>',
                    type: 'POST',
                    data : {
                        'no_spbnon': no_spbnon,
                        'kode_item': kode_item,
    ...
    <script>
        ...
        $('#ADD_SPB').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('truckingnondetail.store2'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#EDIT_SPB').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('truckingnondetail.updateajax3'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
