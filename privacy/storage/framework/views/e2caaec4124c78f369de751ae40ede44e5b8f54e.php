...
<div class="title">
    ...
    <p style="font-size: 8pt">Periode : <?php echo e($insoperator->tgl_pakai_dari); ?> s/d <?php echo e($insoperator->tgl_pakai_sampai); ?></p>
</div>
<div class="header">
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            <tr>
                ...
                <td><?php echo e($operator->nama_operator); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($operator->nik); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
    ...
    <section class="list-item">
        <table class="grid" style="font-size: 8pt; width: 1000px;" border="0" >
            ...
            <tr >
                ...
                <th style="text-align: left; width: 70px;">Time Sheet</th>
                <th style="text-align: left; width: 140px;">Pekerjaan</th>
                ...
                <th style="text-align: center; width: 100px;">Type Alat</th>
            </tr>
            </thead>
        </table>
<hr>
<?php
    ...
    $tanggal2 = null;
?>
        <table class="grid" style="font-size: 7pt; width: 1000px;" border="0" >
            <thead>
            ...
            <?php foreach ($insoperatordetail as $key => $row): ?>
                ...
                <?php if ($tanggal1 == null) { ?>
                    ...
                    <th style="text-align: left; width: 70px;"><?php echo $tanggal1; ?></th>
                <?php }else if ($tanggal1 == $tanggal2) { ?>
                    <th style="text-align: left; width: 70px;"></th>
                <?php }else { ?>
                    <?php $tanggal1 = $row->tgl_pakai; ?>
                    <th style="text-align: left; width: 70px;"><?php echo $tanggal2; ?></th>
                <?php } ?>
                    <th style="text-align: left; width: 70px;"><?php echo $row->no_timesheet; ?></th>
                <?php $alatdetail = PemakaianAlatDetail::where('no_timesheet', $row->no_timesheet)->first(); ?>
                    <th style="text-align: left; width: 140px;"><?php echo $alatdetail->pekerjaan; ?></th>

                <?php if ($row->jam_dr == null) { ?>
                    <th style="text-align: center; width: 45px;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: center; width: 45px;"><?php echo substr($row->jam_dr, 0,5); ?></th>
                <?php } ?>

                <?php if ($row->jam_sp == null) { ?>
                    <th style="text-align: center; width: 45px;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: center; width: 45px;"><?php echo substr($row->jam_sp, 0,5); ?></th>
                <?php } ?>

                <?php if ($row->istirahat == null) { ?>
                    <th style="text-align: center; width: 45px;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: center; width: 45px;"><?php echo substr($row->istirahat, 0,5); ?></th>
                <?php } ?>

                <?php if ($row->stand_by == null) { ?>
                    <th style="text-align: center; width: 45px;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: center; width: 45px;"><?php echo substr($row->stand_by, 0,5); ?></th>
                <?php } ?>
                    
                    <th style="text-align: center; width: 60px;"><?php echo $row->total_jam; ?></th>
                    <th style="text-align: center; width: 45px;"><?php echo number_format($row->hm_dr,'2'); ?></th>
                    <th style="text-align: center; width: 45px;"><?php echo number_format($row->hm_sp,'2'); ?></th>
                    <th style="text-align: center; width: 45px;"><?php echo number_format($row->total_hm,'2'); ?></th>
                <?php if ($row->luar_kota == '1') { ?>
                    <th style="text-align: center; width: 45px;">Y</th>
                <?php }else { ?>
                    <th style="text-align: center; width: 45px;">T</th>
                <?php } ?>
                ...
                <?php $alat = Alat::find($alatdetail->kode_alat); ?>
                    <th style="text-align: center; width: 100px;"><?php echo $alat->type; ?></th>
                </tr>
            <?php endforeach ?>
            </thead>
            <br>
...
<hr>
    <div class="header">
        <div class="left">
            <table width="50%" style="  font-size: 8pt" border="0">
                <tr>
                    <td style="width: 160px">Total Premi (Jam)</td>
                    <td style="width: 10px">:</td>
                    <td><?php echo e(number_format($insoperator->total_premi,'2')); ?></td>
                </tr>
                <tr>
                    <td style="width: 160px">Total Premi Hari Libur</td>
                    <td style="width: 10px">:</td>
                    <td><?php echo e(number_format($insoperator->total_premi_libur,'2')); ?></td>
                </tr>
                <tr>
                    <td style="width: 160px">GT Insentif</td>
                    <td style="width: 10px">:</td>
                    <td><?php echo e(number_format($insoperator->gt_insentif,'2')); ?></td>
                </tr>
            </table>
        </div>
        <div class="right">
            <table width="30%" style="font-size: 8pt" border="0">
                <tr >
                ...
                <tr >
                    ...
                    <td style="width: 10px">:</td>
                    <td><?php echo e($insoperator->total_hari); ?> Hari</td>
                </tr>
                <tr >
