...
<?php $__env->startSection('title', 'Gudang Shipper'); ?>
        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-gudang')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <?php echo e(Form::label('kode_customer', 'Nama Shipper:')); ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
            ...
            <?php echo Form::open(['id'=>'EDIT']); ?>
                ...
                <div class="modal-body">
                        <div class="row">
                            ...
                            <?php echo e(Form::hidden('kode_shipper', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_customer',$Customer->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Customer1','required','placeholder'=>''])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <?php if (app('laratrust')->can('view-gudang')) : ?>
...
<?php $__env->startPush('js'); ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('gudang.getkode'); ?>',
                        type:'POST',
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('gudang.data'); ?>',
            columns: [
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var item = colom;
                    var add = $("#addgudang").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/gudang/"+kode_shipper+"/detail");
                    if(item > 0){
                        $('.add-button').show();
                        $('.hapus-button').hide();
                        $('.edit-button').show();
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('gudang.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_shipper
                    },
            ...
            $('#editgudang').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('gudang.edit_gudang'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_shipper
                    },
            ...
            $('#hapusgudang').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('gudang.hapus_gudang'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_shipper
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('gudang.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('gudang.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
