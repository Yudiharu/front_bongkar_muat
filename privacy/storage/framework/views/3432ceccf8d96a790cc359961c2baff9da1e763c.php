<?php $__env->startSection('title', 'Add Biaya Estimasi'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Biaya Estimasi No. JO <b><?php echo e($joborder->no_joborder); ?></b></font>
    </span>
...
<body onLoad="load()">
    <div class="box box-danger">
        <div class="box-body"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty',null, ['class'=> 'form-control','id'=>'qty1','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('biaya_estimasi',null, ['class'=> 'form-control','id'=>'biaya1','required'])); ?>
            ...
            <div class="editform">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'UPDATE_BIAYA']); ?>
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty',null, ['class'=> 'form-control','id'=>'qty2','required'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('biaya_estimasi',null, ['class'=> 'form-control','id'=>'biaya2','required'])); ?>
   ...
   <div class="box box-danger">
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <button type="button" class="btn btn-warning btn-xs edit-button" id="editbiaya" data-toggle="modal" data-target="">EDIT <i class="fa fa-edit"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('delete-jo')) : ?>
            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapusbiaya" data-toggle="modal" data-target="">HAPUS <i class="fa fa-times-circle"></i></button>
            <?php endif; // app('laratrust')->can ?>
        </div>
</body>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/joborderdetail/getDatabyIDbiaya?id='+no_joborder,
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var id = select.find('td:eq(1)').text();
            ...
            $('#editbiaya').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('joborderdetail.edit_biaya'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                    },
                    success: function(results) {
                        ...
                        $('#biaya2').val(results.biaya_estimasi);
                        $('.editform').show();
                        $('.addform').hide();
                    }
                });
            ...
            $('#hapusbiaya').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('joborderdetail.hapus_biaya'); ?>',
                            type: 'POST',
                            data : {
                                'id': id,
                            },
    ...
    <script>
        ...
        $('#ADD_BIAYA').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('joborderdetail.storebiaya'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#UPDATE_BIAYA').submit(function (e) {
            ...
            var registerForm = $("#UPDATE_BIAYA");
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('joborderdetail.updateajaxbiaya'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        if(data.success === true) {
