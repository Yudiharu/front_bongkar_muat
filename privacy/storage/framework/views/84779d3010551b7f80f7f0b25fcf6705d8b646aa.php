      ...
      <div class="box box-solid">
        <div class="modal fade" id="cetaktrucking"  role="dialog">
            <div class="modal-dialog modal-md" role="document">
              <div class="modal-content">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['trucking.export3'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>

                        <div class="modal-body">
                            <div class="row">
                                <?php echo e(Form::hidden('no_trucking',null, ['class'=> 'form-control','id'=>'no_trucking'])); ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('trucking.getkode'); ?>',
                        type:'POST',
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addtrucking").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/trucking/"+no_trucking+"/detail");
                    var print = $("#printtrucking").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/trucking/export2?no_trucking="+no_trucking);
                    var print2 = $("#printcontainer").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/trucking/export3?no_trucking="+no_trucking);
