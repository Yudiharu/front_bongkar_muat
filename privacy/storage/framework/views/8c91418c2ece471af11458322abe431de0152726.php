...
<head>
    ...
    <br>
    <title>Report Premi Helper ~ <?php echo e($request); ?></title>
    <style>
        @page  {
...
<div class="title">
    ...
    <p style="font-size: 10pt;text-align: center">Periode :<?php echo e($header->tgl_pakai_dari); ?> s/d <?php echo e($header->tgl_pakai_sampai); ?></p>
</div>
<div class="header">
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            <tr>
                ...
                <td><?php echo e($header->helper->nama_helper); ?>&nbsp;&nbsp;&nbsp;</td>
                <td>NIK :<?php echo e($header->helper->nik); ?>&nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table width="10%" style="  font-size: 10pt" border="0">
            <tr>
                ...
                <td style="width: 10px">:</td>
                <td><?php echo e($header->no_insentif); ?>&nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
    </div>
</div>
    ...
    <div class="left">
        <table width="50%" style="  font-size: 11pt" border="0">
            <tr>
                ...
                <td style="width: 10px"></td>
                <td><?php echo e($header->total_dalamkota); ?> Hari&nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td style="width: 250px">Total Hari Kerja Luar Kota</td>
                <td style="width: 10px"></td>
                <td><?php echo e($header->total_luarkota); ?> Hari&nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td style="width: 250px">Total Kerja Hari Libur</td>
                <td style="width: 10px"></td>
                <td><?php echo e($header->total_libur); ?> Hari&nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table width="50%" style="font-size: 11pt; margin-right: -5px;" border="0">
            <tr>
                ...
                <td style="text-align: right; padding-left: 30px;"><?php echo e(number_format($header->total_premi_dalamkota,'2')); ?>&nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td style="width: 270px">Total Premi Luar Kota (Harian)</td>
                <td style="width: 10px"></td>
                <td style="text-align: right"><?php echo e(number_format($header->total_premi_luarkota,'2')); ?>&nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td style="width: 150px"> Total Premi Hari Libur &nbsp;</td>
                <td style="width: 40px"></td>
                <td style="text-align: right"><?php echo e(number_format($header->total_premi_libur,'2')); ?>&nbsp;&nbsp;</td>
            </tr>
        </table>
    </div>
</div>
...
<br>
    <table width="100%" style="font-size:10pt; border-collapse:collapse" border="0">
        ...
        <tr>
            <td style="padding-left:50px"><pre style="font-family: sans-serif;">Dibuat                                      Diperiksa                                 Diperiksa                         Disetujui                         Diterima</pre></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td><pre style="font-family: sans-serif;">&nbsp;&nbsp;&nbsp;<?php echo $user; ?>                DHANU / MARCHENDRO                  ISMANTO                     SUSANTO W                    <?php echo e($header->helper->nama_helper); ?></pre></td>
        </tr>
    </table>
    </section>
</div>
