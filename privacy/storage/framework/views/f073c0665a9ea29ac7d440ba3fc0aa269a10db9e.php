...
<?php $__env->startSection('title', 'Rekap HBU'); ?>
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo Form::open(['route' => ['laporanrekaphbu.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('jenis', 'Tahun:')); ?> 
                                        <?php echo e(Form::selectYear('tahun', 2020, 2040, null, ['class'=> 'form-control select2','id'=>'namatahun','placeholder'=>'','style'=>'width: 100%','required'])); ?>
