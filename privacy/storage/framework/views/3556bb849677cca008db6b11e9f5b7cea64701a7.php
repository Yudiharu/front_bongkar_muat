                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('type_ar', ['Sparepart' => 'Sparepart','Unit' => 'Unit','Jasa' => 'Jasa'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Typear','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('due_date', null, ['class'=> 'form-control','id'=>'Due','required'=>'required', 'placeholder'=>'Tanggal Tenggat','readonly'])); ?>
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpenjualan").attr("href","http://localhost/gui_inventory_sub_laravel/admin/penjualan/"+no_penjualan+"/detail");
                    var print = $("#printpenjualan").attr("href","http://localhost/gui_inventory_sub_laravel/admin/penjualan/exportpdf?no_penjualan="+no_penjualan);
                    var status = colom;
                    var item = colom2;
