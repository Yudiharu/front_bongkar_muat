        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addpembayaran").attr("href","http://localhost/gui_front_emkl_laravel/admin/pembayaran/"+no_pembayaran+"/detail");
                    var print = $("#printpembayaran").attr("href","http://localhost/gui_front_emkl_laravel/admin/pembayaran/export2?no_pembayaran="+no_pembayaran);
