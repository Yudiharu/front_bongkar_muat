        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpenjualan").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/penjualan/"+no_penjualan+"/detail");
                    var print = $("#printpenjualan").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/penjualan/exportpdf?no_penjualan="+no_penjualan);
                    var status = colom;
                    var item = colom2;
