                        ...
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('partnumber', null, ['class'=> 'form-control','id'=>'Part1', 'placeholder'=>'Part Number','required'=>'required','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_ukuran', $Ukuran,null, ['class'=> 'form-control','id'=>'Ukuran','required'=>'required'])); ?>
    ...
    <div class="modal fade" id="button3"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">History Detail [ <button type="button" class="btn btn-primary btn-xs" style="font-size: 10px">GUNAKAN KERTAS UKURAN <b>LEGAL</b></button> ]</h4>
                </div>
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['produk.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('lokasi', 'Lokasi:')); ?>

                                        <?php echo e(Form::select('lokasi',$lokasi,null, ['class'=> 'form-control select2','id'=>'lokasi1','style'=>'width: 100%','placeholder' => ''])); ?>
