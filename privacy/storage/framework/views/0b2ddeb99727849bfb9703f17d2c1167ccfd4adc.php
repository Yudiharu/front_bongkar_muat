...
<?php $__env->startSection('title', 'Premi Helper Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        ...
        <font style="font-size: 16px;"> Premi Helper Detail <b><?php echo e($insentif->no_insentif); ?></b></font>
    </span>
    ...
    <div class="box box-danger">
        <div class="box-body">
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                    <?php echo e(Form::hidden('no_insentif', $no_insentif, ['class'=> 'form-control','id'=>'NoInsentif1','readonly'])); ?>

                    <?php echo e(Form::hidden('kode_helper', $helper, ['class'=> 'form-control','id'=>'KodeHelper1','readonly'])); ?>

                    <?php echo e(Form::hidden('type_helper', $type_helper, ['class'=> 'form-control','id'=>'TypeHelper1','readonly'])); ?>

                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('Helper', 'Nama Helper:')); ?>

                            <?php echo e(Form::text('nama_helper', $Helper->nama_helper, ['class'=> 'form-control','id'=>'Helper1','autocomplete'=>'off','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('Helper', 'Type Helper:')); ?>

                            <?php echo e(Form::text('type_helper', $type, ['class'=> 'form-control','id'=>'Helper1','autocomplete'=>'off','readonly'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('tgl_pakai_dari', $tgldr,['class'=> 'form-control','id'=>'Tanggaldr1' ,'required','readonly'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('tgl_pakai_sampai', $tglsp,['class'=> 'form-control','id'=>'Tanggalsp1' ,'required','readonly'])); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('NamaAlat', 'Nama Alat:')); ?>

                            <?php echo e(Form::text('nama_alat', null,['class'=> 'form-control','id'=>'NamaAlat1' ,'required','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('TypeAlat', 'Kode Tagging:')); ?>

                            <?php echo e(Form::text('type', null,['class'=> 'form-control','id'=>'AsetAlat1' ,'required','readonly'])); ?>
...
<?php $__env->startPush('js'); ?>
        ...
        function hapusall(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('insentifhelperdetail.hapusall'); ?>',
                        type:'POST',
                        data : {
        ...
        function getpakai()
        {
            ...
            var tgl_sp = $('#Tanggalsp1').val();
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('insentifhelperdetail.getpakai'); ?>',
                            type: 'POST',
                            data : {
                                'no_insentif': no_insentif,
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/insentifhelperdetail/getDatabyID?id='+no_insentif,
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    $('.edit-button').show();
                    $.ajax({
                        url: '<?php echo route('insentifhelperdetail.show_alat'); ?>',
                        type: 'POST',
                        data : {
                            'id': id,
                        },
            ...
            $('#editjoborderdetail').click( function () {
                ...
                var id = data['id'];
                $.ajax({
                    url: '<?php echo route('insentifhelperdetail.edit_detail'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                    },
            ...
            $('#hapusdetail').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('insentifhelperdetail.hapus_detail'); ?>',
                            type: 'POST',
                            data : {
                                'id': id,
                            },
    ...
    <script>
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('insentifhelperdetail.store'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('insentifhelperdetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        if(data.success === true) {
