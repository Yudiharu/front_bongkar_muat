...
<?php $__env->startSection('title', 'Job Order Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <?php } ?>
        <font style="font-size: 16px;"> Job Order <b><?php echo e($joborder->no_joborder); ?></b></font>
    </span>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_joborder',$joborder->no_joborder, ['class'=> 'form-control','readonly','id'=>'nojoborder'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('deskripsi',null, ['class'=> 'form-control','id'=>'Desc1','rows'=>'3','required','autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>

                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                            <?php echo e(Form::label('qtys', 'Qty:')); ?>

                            <?php echo e(Form::text('qty',null, ['class'=> 'form-control','id'=>'Qty1','required','autocomplete'=>'off','oninput'=>"validate(this)",'onkeypress'=>"return hanyaAngka(event)"])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('Sats', 'Satuan:')); ?>

                            <?php echo e(Form::select('satuan', $Satuan, null, ['class'=> 'form-control select2','id'=>'Satuan1','required','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('Hargs', 'Harga:')); ?>

                            <?php echo e(Form::text('harga',null, ['class'=> 'form-control','id'=>'Harga1','required','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('mob_demob',0, ['class'=> 'form-control','id'=>'Mob1','autocomplete'=>'off'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('deskripsi',null, ['class'=> 'form-control','id'=>'Desc2','rows'=>'3','required','autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('qty',null, ['class'=> 'form-control','id'=>'Qty2','required','autocomplete'=>'off', 'onkeypress'=>"return hanyaAngka(event)"])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('satuan', $Satuan, null, ['class'=> 'form-control select2','id'=>'Satuan2','required','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('harga',null, ['class'=> 'form-control','id'=>'Harga2','required','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('mob_demob',0, ['class'=> 'form-control','id'=>'Mob2','autocomplete'=>'off'])); ?>
