                ...
                <div class="left">
                    <table width="50%" style="  font-size: 9pt" border="0">
                        <tr>
                            ...
                            <td style="width: 10px"></td>
                            <td style="text-align:right; padding-right:50px;"><?php echo e($header->total_dalamkota); ?> Hari&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="width: 250px">Total Hari Kerja Luar Kota</td>
                            <td style="width: 10px"></td>
                            <td style="text-align:right; padding-right:50px;"><?php echo e($header->total_luarkota); ?> Hari&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="width: 250px">Total Kerja Hari Libur</td>
                            <td style="width: 10px"></td>
                            <td style="text-align:right; padding-right:50px;"><?php echo e($header->total_libur); ?> Hari&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                    </table>
                </div>
                <div class="right">
