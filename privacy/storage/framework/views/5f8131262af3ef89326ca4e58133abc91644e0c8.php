...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-company')) : ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('tipe', ['Pusat' => 'Pusat', 'Cabang' => 'Cabang'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'tipe1','required'=>'required','onchange'=>"tipes();"])); ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group2">
                                    ...
                                    <?php echo e(Form::select('kode_comp', $company, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder'=>'','id'=>'company1','required'=>'required'])); ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-company')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-company')) : ?>
