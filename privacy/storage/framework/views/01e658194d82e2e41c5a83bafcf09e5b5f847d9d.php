                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_timesheet',null, ['class'=> 'form-control','id'=>'NoTS1','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('Mobs', 'Pekerjaan:')); ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
                            <b>
                            <input type="hidden" name="hari_libur" value="0" />
                            <input type="checkbox" name="hari_libur" id="Libur1" value="1"/>&nbsp;Hari Libur?</b>
                            <?php echo e(Form::textarea('pekerjaan',null, ['class'=> 'form-control','id'=>'Pekerjaan1','autocomplete'=>'off','rows'=>'2','onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::time('jam_dr', null,['class'=> 'form-control','id'=>'JamDr1' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::time('jam_sp', null,['class'=> 'form-control','id'=>'JamSp1' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('hm_dr',null, ['class'=> 'form-control','id'=>'HmDr1','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('hm_sp',null, ['class'=> 'form-control','id'=>'HmSp1','autocomplete'=>'off'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_timesheet',null, ['class'=> 'form-control','id'=>'NoTS2','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::time('jam_dr', null,['class'=> 'form-control','id'=>'JamDr2' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::time('jam_sp', null,['class'=> 'form-control','id'=>'JamSp2' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('hm_dr',null, ['class'=> 'form-control','id'=>'HmDr2','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('hm_sp',null, ['class'=> 'form-control','id'=>'HmSp2','autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,   
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/pemakaianalatdetail/getDatabyID?id='+no_pemakaian,
        ...
        $("div.toolbar").html('<b>Keterangan Warna:&nbsp;&nbsp;&nbsp;&nbsp;</b><font style="background-color:#ffbab5;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>&nbsp;:&nbsp;Ada Nomor Timesheet yang melompat.');
