    ...
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            <tr>
                ...
                <td><?php echo e($insoperator->operator->nama_operator); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NIK:&nbsp;<?php echo e($insoperator->operator->nik); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
        ...
        <div class="right">
            <table width="30%" style="font-size: 9pt" border="0">
                <tr >
                    ...
                    <td style="width: 10px">:</td>
                    <td><?php echo e($tojam); ?> Jam <?php echo e($tomin); ?> Menit</td>
                </tr>
                <tr >
...
?>
        <tr>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $user; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ttd1->mengetahui; ?>/<?php echo $ttd2->mengetahui; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ttd4->mengetahui; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ttd5->mengetahui ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ttd3; ?></td>
        </tr>
    </table>
    </section>
</div>
