<?php $__env->startSection('title', 'Pemakaian Ban Detail'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Pemakaian Ban<b><?php echo e($pemakaianban->no_pemakaianban); ?></b></font>
    </span>
                        ...
                        <div class="row">   
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_pemakaianban',$pemakaianban->no_pemakaianban, ['class'=> 'form-control','readonly','id'=>'nopakaiban'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo e(Form::label('partnumber', 'Serial Number Lama:')); ?>

                                        <?php echo e(Form::text('partnumber', null, ['class'=> 'form-control','id'=>'Parts','required'=>'required','style'=>'width: 100%','autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo e(Form::label('partnumberbaru', 'Serial Number Baru:')); ?>

                                        <?php echo e(Form::select('partnumberbaru',[], null, ['class'=> 'form-control','id'=>'Partbarus','required'=>'required','style'=>'width: 100%','autocomplete'=>'off','onchange'=>'getharga();'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::number('qty', null, ['class'=>'form-control','required'=>'required','id'=>'QTY','onkeyup'=>'check();','autocomplete'=>'off','readonly'])); ?>
                    ...
                    <div class="row">   
                        <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_pemakaianban',$pemakaianban->no_pemakaianban, ['class'=> 'form-control','readonly','id'=>'Pemakaian_e'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        var no_pemakaianban = $('#nopakaiban').val();
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_inventory_sub_laravel/admin/pemakaianbandetail/getDatabyID?id='+no_pemakaianban,
  ...
  <script>
        ...
        function stock(){
            ...
            $.ajax({
                url:'<?php echo route('pemakaianbandetail.stockproduk'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                    },
        ...
        function editpart(){
                    ...
                    $.ajax({
                    url: "<?php echo route('pemakaianbandetail.selectpart'); ?>",
                    method: 'POST',
        ...
        function editpart2(){
                    ...
                    var token = $("input[name='_token']").val();
                    $.ajax({
                    url: "<?php echo route('pemakaianbandetail.selectpart2'); ?>",
                    method: 'POST',
                    data: {kode_produk:kode_produk, _token:token},
                    success: function(data) {
                        $("#Partbarus").html('');
        ...
        function editpart3(){
                    ...
                    var token = $("input[name='_token']").val();
                    $.ajax({
                    url: "<?php echo route('pemakaianbandetail.selectpart3'); ?>",
                    method: 'POST',
                    data: {kode_produk:kode_produk, _token:token},
                    success: function(data) {
                        $("#Partbarus2").html('');
        ...
        function getharga(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('pemakaianbandetail.getharga'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'part': partnumber,
        ...
        function getharga2(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('pemakaianbandetail.getharga2'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'part': partnumber,
        ...
        function check(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('pemakaianbandetail.qtycheck'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'satuan': satuan,
        ...
        function cek_qty2(){
            ...
            var qty = $('#QTY_e').val();
             ...
             $.ajax({
                url:'<?php echo route('pemakaianbandetail.qtyproduk2'); ?>',
                type:'POST',
                data : {
        ...
        function editsatuan(){
                    ...
                    var token = $("input[name='_token']").val();
                $.ajax({
                    url: "<?php echo route('pemakaianbandetail.selectAjax'); ?>",
                    method: 'POST',
                    data: {kode_produk:kode_produk, _token:token},
                    success: function(data) {
                        $("#Satuan_e").html('');
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('pemakaianbandetail.check'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            // Check if empty of not
                $.ajax({
                    url:'<?php echo route('pemakaianbandetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
