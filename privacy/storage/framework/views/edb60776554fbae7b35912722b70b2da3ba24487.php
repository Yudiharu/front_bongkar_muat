...
<div class="right">
    <p id="color" style="font-size: 8pt;" align="left"><b>Waktu Cetak : </b><?php echo ($dt) ?><br>Printed By &nbsp;: <?php echo $nama_cetak ?></b></p>
</div>
<div class="title">
    <h1>JOB ORDER</h1>
</div>
    ...
    <div class="left">
        <table width="60%" style="  font-size: 10pt" border="0">
            ...
            <tr>
                <td>Remark</td>
                <td>:</td>
                <td><?php echo e($joborder->kode_consignee); ?></td>
            </tr>
    ...
    <div class="right">
        <table width="40%" style="font-size: 10pt" border="0">
            ...
            <tr>
                <td>Type Kegiatan</td>
                <td>:</td>
                <td><?php echo e($type_kegiatan); ?></td>
            </tr>
            <tr>
                <td>Lokasi</td>
                <td>:</td>
    ...
    <table style="font-size: 10pt;" width="100%" border="0" >
        <thead>
            ...
            <tr>
                ...
                <th width="10%" style="text-align: center; padding-left:50px;">Qty</th>
                <th width="10%" style="text-align: center;">Satuan</th>
                <th width="15%" style="text-align: right;">Unit Rate</th>
                <th width="15%" style="text-align: right;">Mob Demob</th>
        ...
        <table style="font-size: 10pt;" width="100%" border="0" >
            ...
            <?php foreach ($jobrequest as $key => $row): ?>
                <tr >
                    <td width="40%" style="text-align: left; word-spacing: -2px;"><?php echo $row->deskripsi; ?></td>
                    <td width="10%" style="text-align: right;"><?php echo number_format($row->qty,'3'); ?></td>
                    <td width="10%" style="text-align: center;"><?php echo $row->satuan; ?></td>
                    <td width="15%" style="text-align: right;"><?php echo number_format($row->harga,'2'); ?></td>
                    <td width="15%" style="text-align: right;"><?php echo number_format($row->mob_demob,'2'); ?></td>
                    <td width="20%" style="text-align: right;"><?php echo number_format($row->total_harga,'2'); ?></td>
                </tr>
            <?php endforeach ?>
            </tbody>
            <br>
...
?>
    <table width="100%" style="font-size:10pt; border-collapse:collapse" border="0">
        ...
        <?php if (file_exists($cekdibuat)) { ?>
            <td><img src="<?php echo e($cekdibuat); ?>" alt="" height="70px" width="90px" align="center"></td>
        <?php }else { ?>
            <td><br><br><br></td>
        <?php } ?>
        </tr>
