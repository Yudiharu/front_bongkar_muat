        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addtransfer").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/transfer/"+no_transfer+"/detail");
                    var print = $("#printtransfer").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/transfer/exportpdf?no_transfer="+no_transfer);
                    var status = colom;
                    var item = colom2;
