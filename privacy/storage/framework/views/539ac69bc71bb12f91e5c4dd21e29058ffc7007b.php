...
<head>
    ...
    <br>
    <title>VOUCHER KAS BANK TRANSFER</title>
    <style>
        @page  {
...
<div class="title">
    <h1>VOUCHER KAS BANK TRANSFER</h1>
</div>
    ...
    <div class="left">
        <table width="50%" style=" font-size: 10pt" border="0">
            <tr >
                ...
                <td><?php echo e($cashbanktransfer->no_cbt); ?></td>
            </tr>
            <tr>
                <td >Transfer Dari</td>
                <td>:</td>
                <td><?php echo e($cashbank_dari->nama_cashbank); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table width="50%" style="padding-left:8em; font-size: 10pt" border="0">
            ...
            <tr>
                <td>Tujuan</td>
                <td>:</td>
                <td><?php echo e($cashbank_tujuan->nama_cashbank); ?></td>
            </tr>
        </table>
    </div>
</div>
...
<div class="content">
    ...
    <div class="left">
        <table style="padding-left:0mm; font-size:10pt">
            <tr>
                <td><?php echo e($cashbanktransfer->ket_dari); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table style="padding-right:0mm; font-size:10pt">
            <tr>
                <td><?php echo number_format($cashbanktransfer->grand_total,'0','.',',') ?></td>
            </tr>
        </table>
    </div>

<?php
$grand_total = $cashbanktransfer->grand_total;
?>
