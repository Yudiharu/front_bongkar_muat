                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_rekening', null, ['class'=> 'form-control','id'=>'Rek','required'=>'required', 'placeholder'=>'No. Rekening','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    function getcoa(){
        $.ajax({
            url: '<?php echo route('sopir.getcoa'); ?>',
            type: 'POST',
            data : {
            },
