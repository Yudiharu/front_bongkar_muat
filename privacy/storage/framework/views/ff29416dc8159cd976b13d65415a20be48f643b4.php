                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo e(Form::label('kode_pemilik', 'Vendor:')); ?>

                                    <?php echo e(Form::select('kode_pemilik', $Vendor->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Vendor1','required'])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('kode_pemilik', $Vendor->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Vendor2','required'])); ?>
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var item = colom;
                    var add = $("#addpemilik").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/pemilik/"+kode_pemilik+"/detail");
                    if(item > 0){
                        $('.add-button').show();
                        $('.hapus-button').hide();
                        $('.edit-button').show();
