...
<div class="fixed-header">
        ...
        <br><br>
            ...
            <p>Periode: <?php echo format_tgl($hasilbagi->spb_dari) ?> s.d <?php echo format_tgl($hasilbagi->spb_sampai) ?> <br>
                <b>Sopir :</b> <?php echo e($sopir->nama_sopir); ?> / <b>NIS :</b> <?php echo e($sopir->nis); ?> / <b>No. Transaksi :</b> <?php echo e($request); ?> / <b>Tanggal :</b> <?php echo e(format_tgl($hasilbagi->tanggal_hasilbagi)); ?></p>
    </div>
