<?php $__env->startSection('title', 'Cash Bank Out'); ?>
        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-cashbankout')) : ?>
                    <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#addform"><i class="fa fa-plus">
                        </i> New Cash Bank Out</button>
                    <?php endif; // app('laratrust')->can ?>

                    <span class="pull-right">  
                        <font style="font-size: 16px;"><b>CASH BANK OUT</b></font>
                    </span>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tgl_cashbank_out', 'Tanggal Cash Bank Out:')); ?>

                                    <?php echo e(Form::date('tgl_cashbank_out', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('payment_to', 'Payment To:')); ?>

                                    <?php echo e(Form::text('payment_to', null, ['class'=> 'form-control','id'=>'Terima1', 'placeholder'=>'Terima Dari', 'autocomplete'=>'off','required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('jenis_cbo', 'Jenis CBO:')); ?>

                                    <?php echo e(Form::select('jenis_cbo', ['Uang Muka' => 'Uang Muka','Kas Bon' => 'Kas Bon','Lainnya' => 'Lainnya','Penyelesaian Kas' => 'Penyelesaian Kas'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Jenis1','required'=>'required'])); ?>
...
<div class="modal fade" id="editform" tabindex="-1" role="dialog">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_cashbank_out', null, ['class'=> 'form-control','id'=>'Cashin','readonly'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tgl_cashbank_out', null,['class'=> 'form-control','id'=>'Tanggal'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('payment_to', null, ['class'=> 'form-control','id'=>'Terima', 'placeholder'=>'Terima Dari', 'autocomplete'=>'off','required'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('jenis_cbo', ['Uang Muka' => 'Uang Muka','Kas Bon' => 'Kas Bon','Lainnya' => 'Lainnya','Penyelesaian Kas' => 'Penyelesaian Kas'], null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Jenis','required'=>'required'])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-map-marker" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-cashbankout')) : ?>
            <button type="button" class="btn btn-warning btn-xs edit-button" id="editcashbankout" data-toggle="modal" data-target="">EDIT <i class="fa fa-edit"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('add-cashbankout')) : ?>
            <a href="#" id="addcashbankout"><button type="button" class="btn btn-info btn-xs add-button" data-toggle="modal" data-target="">ADD <i class="fa fa-plus"></i></button></a>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('delete-cashbankout')) : ?>
            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapuscashbankout" data-toggle="modal" data-target="">HAPUS <i class="fa fa-times-circle"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('post-cashbankout')) : ?>
            <button type="button" class="btn btn-success btn-xs tombol1" id="button1">POST <i class="fa fa-bullhorn"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('unpost-cashbankout')) : ?>
            <button type="button" class="btn btn-warning btn-xs tombol2" id="button2">UNPOST <i class="fa fa-undo"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('view-cashbankout')) : ?>
            <button type="button" class="btn btn-primary btn-xs view-button" id="button5">VIEW <i class="fa fa-eye"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('print-cashbankout')) : ?>
            <a href="#" target="_blank" id="printcashbankout"><button type="button" class="btn btn-danger btn-xs print-button" id="button6">PRINT <i class="fa fa-print"></i></button></a>
            <?php endif; // app('laratrust')->can ?>
        </div>
</body>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('cashbankout.data'); ?>',

            columns: [
                { data: 'no_cashbank_out', name: 'no_cashbank_out' },
                { data: 'tgl_cashbank_out', name: 'tgl_cashbank_out' },
        ...
        function jurnal(){
            ...
            var tgl_cashbank_in= $('#Tanggal1').val();
             ...
             $.ajax({
                url:'<?php echo route('cashbankout.jurnal'); ?>',
                type:'POST',
                data : {
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var no_cashbank_out = select.find('td:eq(0)').text();
                    var add = $("#addcashbankout").attr("href","http://localhost/gui_inventory_laravel/admin/cashbankout/"+no_cashbank_out+"/detail");
                    var print = $("#printcashbankout").attr("href","http://localhost/gui_inventory_laravel/admin/cashbankout/exportpdf?no_cashbank_out="+no_cashbank_out);
                    var status = colom;
                    var item = colom2;
           ...
           $('#button1').click( function () {
                ...
                var no_cashbank_out = colom;
                console.log(no_cashbank_out);
                swal({
                    title: "Post?",
                    text: colom,
                    type: "warning",
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('cashbankout.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_cashbank_out
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('cashbankout.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_cashbank_out
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('cashbankout.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_cashbank_out
                    },
            ...
            $('#editcashbankout').click( function () {
                var select = $('.selected').closest('tr');
                var no_cashbank_out = select.find('td:eq(0)').text();
                var row = table.row( select );
                console.log(no_cashbank_out);
                $.ajax({
                    url: '<?php echo route('cashbankout.edit_cashbankout'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_cashbank_out
                    },
                    success: function(results) {
                        console.log(results);
                        $('#Cashin').val(results.no_cashbank_out);
                        $('#Tanggal').val(results.tgl_cashbank_out);
                        $('#Jurnal').val(results.kode_jurnal);
                        $('#Terima').val(results.payment_to);
                        $('#Ref').val(results.no_reff);
                        $('#Jenis').val(results.jenis_cbo);
            ...
            $('#hapuscashbankout').click( function () {
                var select = $('.selected').closest('tr');
                var no_cashbank_out = select.find('td:eq(0)').text();
                var row = table.row( select );
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('cashbankout.hapus_cashbankout'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_cashbank_out
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('cashbankout.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('cashbankout.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
