...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Spb Non-Container<b> <?php echo e($spbnon->no_spbnon); ?></b></font>
    </span>
                        ...
                        <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_spbnon',$spbnon->no_spbnon, ['class'=> 'form-control','readonly','id'=>'spbnon'])); ?>
                            ...
                            <div class="row">   
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_spbnon',$spbnon->no_spbnon, ['class'=> 'form-control','readonly','id'=>'spbnon2'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_item',null, ['class'=> 'form-control','required','id'=>'item2'])); ?>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty',null, ['class'=> 'form-control','required','id'=>'qty2','onkeyup'=>'gettotal2()'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('berat_satuan',null, ['class'=> 'form-control','required','id'=>'berat2','onkeyup'=>'gettotal2()'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('total_berat',null, ['class'=> 'form-control','required','id'=>'total2', 'readonly'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'keterangan2', 'placeholder'=>'Keterangan', 'autocomplete'=>'off','required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/spbnondetail/getDatabyID?id='+no_spbnon,
    ...
    <script>
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('spbnondetail.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('spbnondetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        if(data.success === true) {
