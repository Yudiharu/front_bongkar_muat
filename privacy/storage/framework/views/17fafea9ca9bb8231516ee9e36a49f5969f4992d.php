...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-alat')) : ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('type', null, ['class'=> 'form-control','id'=>'Nama3','required'=>'required', 'placeholder'=>'', 'style'=>'width: 100%','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::selectYear('tahun', 2000, 2040, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nama4','required'=>'required', 'autocomplete'=>''])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset_alat', null, ['class'=> 'form-control','id'=>'Asset1', 'placeholder'=>'No. Asset', 'autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 15 Karakter", 'maxlength'=>'15','required'=>'required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_alat', null, ['class'=> 'form-control','id'=>'Nama','required'=>'required', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('type', null, ['class'=> 'form-control','id'=>'Type','required'=>'required', 'style'=>'width: 100%','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::selectYear('tahun', 2000, 2040, null, ['class'=> 'form-control','id'=>'Tahun','required'=>'required', 'autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_asset_alat', null, ['class'=> 'form-control','id'=>'Asset', 'autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 15 Karakter", 'maxlength'=>'15', 'onkeypress'=>"return pulsar(event,this)"])); ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="box-body"> 
                    <div class="addform">
                        <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo Form::open(['id'=>'ADD_PREMI']); ?>

                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('Nama', 'Nama Alat:')); ?>

                                <?php echo e(Form::text('nama_alat', null, ['class'=> 'form-control','id'=>'NamaAlat1','required'=>'required', 'autocomplete'=>'off', 'readonly'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::date('tgl_berlaku', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tgl1','required'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('premi', 'Premi Per Jam Non Transhipment:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('premi_jam_nontranshipment',null, ['class'=> 'form-control','id'=>'NonTrans1','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('premi', 'Premi Per Jam Transhipment:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('premi_jam_transhipment',null, ['class'=> 'form-control','id'=>'Trans1','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('premi', 'Premi Opr Tembak:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('premi_opr_tembak',null, ['class'=> 'form-control','id'=>'Opr1','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('libur', 'Tambahan kerja hari libur:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('hari_libur',null, ['class'=> 'form-control','id'=>'Libur1','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <?php echo e(Form::hidden('kode_alat', null, ['class'=> 'form-control','readonly','id'=>'KodeAlat1'])); ?>

                        <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'id1'])); ?>

                        <div class="col-md-12">
                            <span class="pull-right"> 
                                <?php echo e(Form::submit('Add Item', ['class' => 'btn btn-primary btn-xs simpanbutton','id'=>'submit'])); ?>  
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="box-body"> 
                    <div class="addform">
                        <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo Form::open(['id'=>'ADD_PREMI2']); ?>

                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('Nama', 'Nama Alat:')); ?>

                                <?php echo e(Form::text('nama_alat', null, ['class'=> 'form-control','id'=>'NamaAlat1h','required'=>'required', 'autocomplete'=>'off', 'readonly'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::date('tgl_berlaku', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tgl1h','required'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('premi', 'Premi harian dalam kota:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('premi_harian_dk',null, ['class'=> 'form-control','id'=>'DalamKota1','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('premi', 'Premi harian luar kota:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('premi_harian_lk',null, ['class'=> 'form-control','id'=>'LuarKota1','style'=>'width: 60%'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('hari_libur',null, ['class'=> 'form-control','id'=>'Libur1h','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <?php echo e(Form::hidden('kode_alat', null, ['class'=> 'form-control','readonly','id'=>'KodeAlat1h'])); ?>

                        <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'id1h'])); ?>

                        <div class="col-md-12">
                            <span class="pull-right"> 
                                <?php echo e(Form::submit('Add Item', ['class' => 'btn btn-primary btn-xs simpanbutton2','id'=>'submit'])); ?>  
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="box-body"> 
                    <div class="addform">
                        <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo Form::open(['id'=>'ADD_PREMI3']); ?>

                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('Nama', 'Nama Alat:')); ?>

                                <?php echo e(Form::text('nama_alat', null, ['class'=> 'form-control','id'=>'NamaAlat1x','required'=>'required', 'autocomplete'=>'off', 'readonly'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::date('tgl_berlaku', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tgl1x','required'])); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo e(Form::label('premi', 'Tarif Alat:', ['style'=>'font-size: 12px'])); ?>

                                <?php echo e(Form::text('tarif',null, ['class'=> 'form-control','id'=>'Tarif1','style'=>'width: 60%'])); ?>

                            </div>
                        </div>
                        <?php echo e(Form::hidden('kode_alat', null, ['class'=> 'form-control','readonly','id'=>'KodeAlat1x'])); ?>

                        <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'id1x'])); ?>

                        <div class="col-md-12">
                            <span class="pull-right"> 
                                <?php echo e(Form::submit('Add Item', ['class' => 'btn btn-primary btn-xs simpanbutton3','id'=>'submit'])); ?>  
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <?php if (app('laratrust')->can('update-alat')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-alat')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function tablepremi(kode){
            $.ajax({
                url: '<?php echo route('alat.getDatapremi'); ?>',
                type: 'GET',
                data : {
                    'id': kode
                },
        ...
        function tablepremi2(kode){
            $.ajax({
                url: '<?php echo route('alat.getDatapremi2'); ?>',
                type: 'GET',
                data : {
                    'id': kode
                },
        ...
        function tablepremi3(kode){
            $.ajax({
                url: '<?php echo route('alat.getDatapremi3'); ?>',
                type: 'GET',
                data : {
                    'id': kode
                },
        ...
        $(document).ready(function(){
            ...
            $('#alat-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var addmt = $("#addlokasi").attr("href","https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/alat/"+kode_alat+"/detaillokasi");
                    $('.add-button').show();
                    $('.hapus-button').show();
                    $('.edit-button').show();
                    $('.premi-button').show();
            ...
            $('#editalat').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('alat.edit_alat'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_alat
                    },
            ...
            $('#hapusalat').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('alat.hapus_alat'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_alat
                            },
            ...
            $('#editpremi').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('alat.editpremi'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
            ...
            $('#editpremi2').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('alat.editpremi2'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                        'tgl_berlaku': tgl_berlaku,
            ...
            $('#editpremi3').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('alat.editpremi3'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                        'tgl_berlaku': tgl_berlaku,
            ...
            $('#hapuspremi').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('alat.hapuspremi'); ?>',
                            type: 'POST',
                            data : {
                                'id': id,
                                'kode_alat': kode,
            ...
            $('#hapuspremi2').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('alat.hapuspremi2'); ?>',
                            type: 'POST',
                            data : {
                                'id': id,
                                'kode_alat': kode,
            ...
            $('#hapuspremi3').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('alat.hapuspremi3'); ?>',
                            type: 'POST',
                            data : {
                                'id': id,
                                'kode_alat': kode,
        ...
        $('#ADD_PREMI').submit(function (e) {
            ...
            var kode = $('#KodeAlat1').val();
            $.ajax({
                url:'<?php echo route('alat.storepremi'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
        ...
        $('#ADD_PREMI2').submit(function (e) {
            ...
            var kode = $('#KodeAlat1h').val();
            $.ajax({
                url:'<?php echo route('alat.storepremi2'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
        ...
        $('#ADD_PREMI3').submit(function (e) {
            ...
            var kode = $('#KodeAlat1x').val();
            $.ajax({
                url:'<?php echo route('alat.storepremi3'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
