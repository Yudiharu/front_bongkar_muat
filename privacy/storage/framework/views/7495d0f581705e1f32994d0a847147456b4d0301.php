            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <span class="pull-right"> 
                        ...
                        <!--  -->
                        <!--<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#button3"><i class="fa fa-print"></i> PRINT</button>-->
    ...
    <div class="modal fade" id="button3"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['penerimaan.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('no_penerimaan', $no_penerimaan, null, ['class'=> 'form-control select2','id'=>'nomor','required'=>'required', 'placeholder'=>'','style'=>'width: 100%'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $.each( result, function( key, row ) {
            ...
            total_pakai = (harga * qty) + landedcost;
