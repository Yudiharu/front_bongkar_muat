                        ...
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('berat_satuan',null, ['class'=> 'form-control','required','id'=>'berat','onkeyup'=>'gettotal()','autocomplete'=>'off'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('kode_item',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'item3','required'=>'required','autocomplete'=>'off'])); ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('qty',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'qty3','required'=>'required','onkeyup'=>'gettotal2()','autocomplete'=>'off'])); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('berat_satuan',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'berat3','required'=>'required','onkeyup'=>'gettotal2()','autocomplete'=>'off'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'keterangan3', 'placeholder'=>'Keterangan', 'autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/truckingnondetail/getDatabyID2?id='+no_spbnon,
            ...
            columns: [
                ...
                { data: 'kode_item', "defaultContent": "<i>Not set</i>" },
                { data: 'qty', "defaultContent": "<i>Not set</i>" },
                { data: 'berat_satuan',
    ...
    <script>
        ...
        function back(){
            // history.go(-1);
            var notruckingnon = $('#notruckingnon').val();
            window.location.replace("http://localhost/gui_front_emkl_laravel/admin/truckingnon/"+notruckingnon+"/detail");
        }
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('truckingnondetail.updateajax2'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
