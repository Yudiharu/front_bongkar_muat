...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-transaksisetup')) : ?>
                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addform">
                        <i class="fa fa-plus"></i> New Type</button>
                        <?php endif; // app('laratrust')->can ?>

                        <span class="pull-right"> 
                            <font style="font-size: 16px;"><b>Type JO</b></font>
                        </span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('nama_transaksi', 'Deskripsi:')); ?>

                            <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Desc1','required'=>'required', 'placeholder'=>'Desc','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Desc2','required'=>'required', 'placeholder'=>'Desc','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
...
<div id="mySidenav" class="sidenav">
    <?php if (app('laratrust')->can('update-transaksisetup')) : ?>
    ...
    <?php if (app('laratrust')->can('delete-transaksisetup')) : ?>
      ...
      tecla = (document.all) ? e.keyCode : e.which;
        ...
        $(function() {
            $('#merek-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo route('typejo.data'); ?>',
                columns: [
        ...
        $(document).ready(function() {
            ...
            $('#edittransaksisetup').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('typejo.edit_transaksisetup'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_setup
                    },
            ...
            $('#hapustransaksisetup').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('typejo.hapus_transaksisetup'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_setup
                            },
       ...
       $('#ADD').submit(function (e) {
        ...
        $.ajax({
            url:'<?php echo route('typejo.store'); ?>',
            type:'POST',
            data:formData,
       ...
       $('#EDIT').submit(function (e) {
        ...
        var formData = registerForm.serialize();
        $.ajax({
            url:'<?php echo route('typejo.ajaxupdate'); ?>',
            type:'POST',
            data:formData,
            success:function(data) {
                console.log(data);
