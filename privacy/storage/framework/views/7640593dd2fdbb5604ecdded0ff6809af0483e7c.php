...
<br><br>
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(url(config('adminlte.dashboard_url', 'home'))); ?>"><font style="color: black; text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #08e0e5, 0 0 40px #08e0e5, 0 0 50px #08e0e5, 0 0 60px #08e0e5, 0 0 70px #08e0e5;"><?php echo config('adminlte.logo', '<b>Admin</b>LTE'); ?></font></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="<?php echo e(url(config('adminlte.login_url', 'login'))); ?>" method="post">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <button type="submit" class="btn btn-warning btn-block btn-flat"><?php echo e(trans('adminlte::adminlte.sign_in')); ?></button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
