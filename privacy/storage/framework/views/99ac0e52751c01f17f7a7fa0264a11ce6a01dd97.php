<?php $__env->startSection('title', 'Jenis Alat'); ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama', 'Kode Jenis:')); ?>

                            <?php echo e(Form::text('kode_jenis', null, ['class'=> 'form-control','id'=>'Jenis1','required'=>'required', 'placeholder'=>'Kode Jenis Alat','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>

                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama', 'Desc:')); ?>

                            <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Desc1','required'=>'required', 'placeholder'=>'Description','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('kode_jenis', null, ['class'=> 'form-control','id'=>'Jenis2','required'=>'required', 'placeholder'=>'Kode Jenis Alat','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Desc2','required'=>'required', 'placeholder'=>'Description','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function() {   
        $('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('jenisalat.data'); ?>',
            columns: [
        ...
        $(document).ready(function(){
            ...
            $('#editjenis').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('jenisalat.edit_jenis'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_sopir
                    },
            ...
            $('#hapusjenis').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('jenisalat.hapus_jenis'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_sopir
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('jenisalat.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
            $.ajax({
                url:'<?php echo route('jenisalat.ajaxupdate'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
