...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-taxsetup')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_pajak', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Pajak','required'=>'required', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_pajak', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Pajak', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('Tanggals', 'Tanggal Berlaku:')); ?>

                                    <?php echo e(Form::date('tgl_berlaku', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'])); ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tgl_berlaku', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal2' ,'required'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-taxsetup')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-taxsetup')) : ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#edittaxsetup').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('taxsetup.edit_taxsetup'); ?>',
                    type: 'POST',
                    data : {
                        'id': id_pajak
                    },
            ...
            $('#hapustaxsetup').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('taxsetup.hapus_taxsetup'); ?>',
                            type: 'POST',
                            data : {
                                'id': id_pajak
                            },
