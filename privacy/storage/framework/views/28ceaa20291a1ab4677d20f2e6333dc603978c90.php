        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-pemakaian')) : ?>
...
<div class="modal fade" id="addform"  role="dialog">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('pemakai', null, ['class'=> 'form-control','id'=>'Pemakai1','required'=>'required', 'placeholder'=>'Pemakai', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;",'onkeypress'=>"return hanyaHuruf(event)"])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group20">
                                        <br>
                                        <?php echo e(Form::label('hmkm', 'HM/KM:')); ?>

                                        <?php echo e(Form::text('hmkm', null, ['class'=> 'form-control','id'=>'hmkm1', 'placeholder'=>'HourMeter/KiloMeter', 'autocomplete'=>'off'])); ?>
                                ...
                                <div class="row">                                
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('pemakai', null, ['class'=> 'form-control','id'=>'Pemakai', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php echo e(Form::text('hmkm', null, ['class'=> 'form-control','id'=>'hmkm2', 'placeholder'=>'HourMeter/KiloMeter', 'autocomplete'=>'off'])); ?>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-pemakaian')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-pemakaian')) : ?>
            ...
            <?php if (app('laratrust')->can('add-pemakaian')) : ?>
            ...
            <?php if (app('laratrust')->can('post-pemakaian')) : ?>
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpemakaian").attr("href","http://localhost/gui_inventory_sub_laravel/admin/pemakaian/"+no_pemakaian+"/detail");
                    var print = $("#printpemakaian").attr("href","http://localhost/gui_inventory_sub_laravel/admin/pemakaian/export2?no_pemakaian="+no_pemakaian);
                    var status = colom;
                    var item = colom2;
            ...
            $('#editpemakaian').click( function () {
                ...
                console.log(no_pemakaian);
                $.ajax({
                    url: '<?php echo route('pemakaian.edit_pemakaian'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_pemakaian
                    },
            ...
            $('#hapuspemakaian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('pemakaian.hapus_pemakaian'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pemakaian
                            },
