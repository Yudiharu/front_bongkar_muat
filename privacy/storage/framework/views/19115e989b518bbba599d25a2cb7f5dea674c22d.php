<?php $__env->startSection('title', 'SPB Container'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('no_spbmanual', 'SPB Manual:')); ?>

                                    <?php echo e(Form::text('no_spbmanual', null, ['class'=> 'form-control','id'=>'Manual1', 'placeholder'=>'No SPB Manual', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_spb', null, ['class'=> 'form-control','id'=>'Spb','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_spbmanual', null, ['class'=> 'form-control','id'=>'Manual', 'placeholder'=>'No SPB Manual', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var status = colom;
                    var add = $("#addpembelian").attr("href","http://localhost/gui_front_emkl_laravel/admin/joborder/"+no_spb+"/detail");
                    if(status == 'POSTED'){
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('spb.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_spb
                    },
            ...
            $('#editspb').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('spb.edit_spb'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_spb
                    },
            ...
            $('#hapusspb').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('spb.hapus_spb'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_spb
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('spb.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
