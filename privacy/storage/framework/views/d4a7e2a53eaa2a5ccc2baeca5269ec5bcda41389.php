...
<body onLoad="load()">
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <?php echo e(Form::hidden('kode_helper', $insentif->kode_helper, ['class'=> 'form-control','id'=>'KodeHelper1','readonly'])); ?>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('nomors', 'Type Helper:')); ?>

                            <?php echo e(Form::text('tipe',$type, ['class'=> 'form-control','readonly','id'=>'Type1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('nomors', 'Nama Helper:')); ?>

                            <?php echo e(Form::text('helpers',$Helper->nama_helper, ['class'=> 'form-control','readonly','id'=>'Nama1'])); ?>
