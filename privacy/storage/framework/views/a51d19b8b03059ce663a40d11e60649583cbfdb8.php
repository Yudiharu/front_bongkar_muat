                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group3">
                                            ...
                                            <?php echo e(Form::select('kode_sopir',$Sopir->sort(),null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Sopir'])); ?>

                                        </div>
                                        <div class="form-group4">
                                            <?php echo e(Form::label('sopir', 'Sopir:')); ?>

                                            <?php echo e(Form::text('sopir',null, ['class'=> 'form-control','id'=>'Sopirnama','readonly'])); ?>
