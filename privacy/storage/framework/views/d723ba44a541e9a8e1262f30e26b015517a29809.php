...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/joborderdetail/getDatabyID2?id='+no_req_jo,
    ...
    <script>
        ...
        function back(){
            ...
            window.location.replace("http://localhost/gui_front_emkl_laravel/admin/joborder/"+nojoborder+"/detail");
        }
