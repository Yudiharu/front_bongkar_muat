        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpemakaianban").attr("href","http://localhost/gui_inventory_sub_laravel/admin/pemakaianban/"+no_pembelian+"/detail");
                    var print = $("#printpemakaianban").attr("href","http://localhost/gui_inventory_sub_laravel/admin/pemakaianban/export2?no_pemakaianban="+no_pembelian);
                    var status = colom;
                    var item = colom2;
