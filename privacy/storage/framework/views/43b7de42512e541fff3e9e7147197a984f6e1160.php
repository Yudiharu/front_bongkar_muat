                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group16">
                                    ...
                                    <?php echo e(Form::selectYear('tahun', 2000, 2045, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nama4','required'=>'required', 'autocomplete'=>''])); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                        ...
                                        <?php echo e(Form::date('kir', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'kir' ,'required'=>'required'])); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                        ...
                                        <?php echo e(Form::date('masa_stnk', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'stnk' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group14">
                                    ...
                                    <?php echo e(Form::select('status_mobil', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'stat','required'=>'required'])); ?>
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_jenis_mobil',null, ['class'=> 'form-control','id'=>'Jenis','required','readonly','style'=>'width: 100%'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::selectYear('tahun', 2000, 2045, null, ['class'=> 'form-control','id'=>'Tahun2','required'=>'required', 'autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset_mobil', null, ['class'=> 'form-control','id'=>'Asset','required'=>'required','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
