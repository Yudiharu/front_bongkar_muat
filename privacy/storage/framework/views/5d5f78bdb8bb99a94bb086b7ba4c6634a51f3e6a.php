...
<?php $__env->startSection('title', 'Lokasi Mobil'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Mobil <b><?php echo e($cust->nopol); ?></b></font>
    </span>
    ...
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                <?php echo e(Form::hidden('kode_mobil',$cust->kode_mobil, ['class'=> 'form-control','readonly','id'=>'KodeCust1'])); ?>

                <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'Id1'])); ?>

                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Nomors', 'No Polisi Mobil:')); ?>

                            <?php echo e(Form::text('noomor', $cust->nopol, ['class'=> 'form-control','id'=>'Nama1','readonly'])); ?>
...
<script>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_02/admin/mobil/getDatabyID?kode_customer='+kode,
            data:{'kode':kode},
            columns: [
    ...
    function formatStatus(n) {
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('mobil.store_lokasi'); ?>',
                type:'POST',
                data:formData,
