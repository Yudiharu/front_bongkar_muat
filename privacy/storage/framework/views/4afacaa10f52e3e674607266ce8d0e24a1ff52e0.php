<?php $__env->startSection('title', 'Jenis Harga'); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama', 'Description:')); ?>

                            <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Jenis1','required'=>'required', 'placeholder'=>'Kode Harga','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('description', null, ['class'=> 'form-control','id'=>'Jenis2','required'=>'required', 'placeholder'=>'Kode Jenis Harga','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function() {   
        $('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('jenisharga.data'); ?>',
            columns: [
        ...
        $(document).ready(function(){
            ...
            $('#editjenis').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('jenisharga.edit_jenis'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#hapusjenis').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('jenisharga.hapus_jenis'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_sopir
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('jenisharga.store'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
            $.ajax({
                url:'<?php echo route('jenisharga.ajaxupdate'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
