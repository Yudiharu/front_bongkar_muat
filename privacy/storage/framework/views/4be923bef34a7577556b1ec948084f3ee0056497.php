                ...
                <div class="addform">
                    ...
                    <center><kbd>ADD FORM</kbd></center><br>
                        <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <?php echo e(Form::label('landedcost', 'Landed Cost Satuan:')); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group8">
                                        <?php echo e(Form::label('tipepo', 'Jenis PO Ban:')); ?>

                                        <?php echo e(Form::select('tipepo', ['1' => 'Beli Original', '2' => 'Ban Lama di Vulkanisir'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'tipepo','onchange'=>'pilih();'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group4">
                                        <?php echo e(Form::label('tipeban', 'Tipe Ban:')); ?>

                                        <?php echo e(Form::select('tipeban', ['1' => 'HALUS', '2' => 'KASAR'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'ban1'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group5">
                                        <?php echo e(Form::label('kate', 'Kategori Ban:')); ?>

                                        <?php echo e(Form::text('katban', null, ['class'=> 'form-control',
                                ...
                                <div class="col-md-2">
                                    <div class="form-group7">
                                        <?php echo e(Form::label('partnumberlama', 'Serial Ban Lama:')); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        var no_penerimaan = $('#noterima').val();
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_inventory_sub_laravel/admin/penerimaandetail/getDatabyID?id='+no_penerimaan,
    ...
    <script>
        ...
        function isipart(){
            ...
            if(tipeban == ''){
             ...
             $.ajax({
                url:'<?php echo route('penerimaandetail.isipart'); ?>',
                type:'POST',
                data : {
                        'tipe': tipeban,
        ...
        function checkpart(){
            ...
            if (partnumberlama == '' || produk == ''){
                ...
                $.ajax({
                    url:'<?php echo route('penerimaandetail.checkpart'); ?>',
                    type:'POST',
                    data : {
                            'part': partnumberlama,
                            'kode_produk': produk,
