<?php $__env->startSection('title', 'Jasa'); ?>
...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-jasa')) : ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo e(Form::label('nama_item', 'Nama Jasa:')); ?>

                            <?php echo e(Form::text('nama_item', null, ['class'=> 'form-control','id'=>'Nama', 'autocomplete'=>'off','readonly'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-jasa')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-jasa')) : ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#editjasa').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('jasa.edit_jasa'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_produk
                    },
            ...
            $('#hapusjasa').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('jasa.hapus_jasa'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_produk
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('jasa.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
