...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-operator')) : ?>
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('nix', 'Kontak PIC:')); ?>

                                    <?php echo e(Form::text('kontak_pic', null, ['class'=> 'form-control','id'=>'Kontak1', 'placeholder'=>'','autocomplete'=>'off'])); ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
                        ...
                        <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kontak_pic', null, ['class'=> 'form-control','id'=>'Kontak2', 'placeholder'=>'','autocomplete'=>'off'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-operator')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-operator')) : ?>
