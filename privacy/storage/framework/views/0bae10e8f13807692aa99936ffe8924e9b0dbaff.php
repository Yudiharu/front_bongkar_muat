        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpenerimaan").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/penerimaan/"+no_penerimaan+"/detail");
                    var print = $("#printpenerimaan").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/penerimaan/exportpdf?no_penerimaan="+no_penerimaan);
                    var status = colom;
                    var item = colom2;
