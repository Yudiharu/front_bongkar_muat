<?php $__env->startSection('title', 'Membership Customer'); ?>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama customer', 'Nama Customer:')); ?><br>
                            <?php echo e(Form::select('kode_customer', $Customer->sort(), null, ['class'=> 'form-control select2', 'style'=>'width: 100%','placeholder'=>'','id'=>'KodeCust1','required'=>'required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('membershipcustomer.data'); ?>',
            columns: [
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addmember").attr("href","http://localhost/gui_front_depo_laravel/admin/membershipcustomer/"+customer+"/detail");
                    $('.hapus-button').show();
                    $('.add-button').show();
                }
            });
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('membershipcustomer.store'); ?>',
                    type:'POST',
                    data:formData,
