        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addjo").attr("href","http://localhost/gui_front_pbm_laravel/admin/pemakaianalat/"+no_pemakaian+"/detail");
                    var print = $("#printjr").attr("href","http://localhost/gui_front_pbm_laravel/admin/pemakaianalat/exportpdf?no_pemakaian="+no_pemakaian);
                    if(status == 'POSTED'){
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
