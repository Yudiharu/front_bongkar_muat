<?php $__env->startSection('title', 'Pemilik Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Pemilik <b><?php echo e($pemilik->kode_pemilik); ?></b></font>
    </span>
                        ...
                        <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <?php echo e(Form::label('kode_pemilik', 'Kode Pemilik:')); ?>

                                        <?php echo e(Form::text('kode_pemilik',$pemilik->kode_pemilik, ['class'=> 'form-control','readonly','id'=>'kodepemilik'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_pemilik',$pemilik->nama_pemilik, ['class'=> 'form-control','readonly','id'=>'namapemilik'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_jenis_mobil',null, ['class'=> 'form-control','readonly','id'=>'jenis'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('kir',null,['class'=> 'form-control','id'=>'kir' ,'required'=>'required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('masa_stnk', null,['class'=> 'form-control','id'=>'stnk' ,'required'=>'required','readonly'])); ?>
                            ...
                            <div class="row">   
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_pemilik',$pemilik->kode_pemilik, ['class'=> 'form-control','readonly','id'=>'kodepemilik2'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_mobil',$Mobil->sort(),null, ['class'=> 'form-control','required','id'=>'kode_mobil2','onchange'=>'getjenis2();'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_jenis_mobil',null, ['class'=> 'form-control','readonly','id'=>'jenis2'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('kir',null,['class'=> 'form-control','id'=>'kir2' ,'required'=>'required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('masa_stnk', null,['class'=> 'form-control','id'=>'stnk2' ,'required'=>'required','readonly'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_emkl_laravel/admin/pemilikdetail/getDatabyID?id='+kode_pemilik,
            data:{'kode_pemilik':kode_pemilik},

            columns: [
                { data: 'kode_pemilik', name: 'kode_pemilik' },
                { data: 'mobil.nopol', name: 'mobil.nopol' },
                { data: 'jenismobil.nama_jenis_mobil', name: 'jenismobil.nama_jenis_mobil' },
                { data: 'mobil.kir', name: 'mobil.kir' },
                { data: 'mobil.masa_stnk', name: 'mobil.masa_stnk' },
            ]
    ...
    <script>
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('pemilikdetail.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('pemilikdetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#QTY2').val('');
