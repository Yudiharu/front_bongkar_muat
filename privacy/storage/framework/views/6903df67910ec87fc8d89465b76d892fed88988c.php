        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpemakaian").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/pemakaian/"+no_pemakaian+"/detail");
                    var print = $("#printpemakaian").attr("href","http://localhost/gui_inventory_sub_laravel_trial/admin/pemakaian/export2?no_pemakaian="+no_pemakaian);
                    var status = colom;
                    var item = colom2;
