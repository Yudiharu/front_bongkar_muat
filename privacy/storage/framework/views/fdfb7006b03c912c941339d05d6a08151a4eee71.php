...
<?php $__env->startSection('title', 'LR Mobil'); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title"><b>L/R Mobil</b></h4>
                    </div>
                    <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo Form::open(['route' => ['laporanlrmobil.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>

                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('awals', 'Tanggal Awal:')); ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('akhirs', 'Tanggal Akhir:')); ?>
