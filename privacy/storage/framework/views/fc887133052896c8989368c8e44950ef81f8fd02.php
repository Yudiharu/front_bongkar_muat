...
<div class="modal fade" id="addform" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <?php echo Form::open(['route' => ['adjustment.store'],'method' => 'post','id'=>'form1']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggal', \Carbon\Carbon::now(),['class'=> 'form-control'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_produk',$produk,null, ['class'=> 'form-control'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('jumlah', null, ['class'=> 'form-control'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'4'])); ?>
...
<div class="modal fade" id="editform" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['adjustment.updateAdjusment'],'method' => 'post','id'=>'form']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_penyesuaian', null, ['class'=> 'form-control','id'=>'Penyesuaian','readonly'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_produk',$produk,null, ['class'=> 'form-control','id'=>'Kode'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_produk', null, ['class'=> 'form-control','id'=>'NamaP'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('jumlah', null, ['class'=> 'form-control','id'=>'Jumlah'])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'4','id'=>'Keterangan'])); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
           ...
           $('#button1').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('adjustment.post'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_penyesuaian
                    },
            ...
            $('#button2').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                $.ajax({
                    url: '<?php echo route('adjustment.unpost'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_penyesuaian
                    },
