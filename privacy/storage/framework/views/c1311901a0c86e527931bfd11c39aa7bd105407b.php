                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::hidden('type_kegiatan', null, ['class'=> 'form-control','id'=>'Type1','readonly'])); ?>

                            <br>
                            <?php echo e(Form::label('Nama customer', 'Jenis Kegiatan:')); ?>

                            <?php echo e(Form::select('id_kegiatan', $Kegiatan, null, ['class'=> 'form-control select2','id'=>'Kegiatan1','required'=>'required', 'placeholder'=>'','style'=>'width: 100%','onchange'=>'tipe();'])); ?>
                    ...
                    <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group5">
                                <?php echo e(Form::label('item', 'Tipe Tarif:')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('id_kegiatan', [], null, ['class'=> 'form-control select2','id'=>'Kegiatan2','required', 'placeholder'=>'','style'=>'width: 100%'])); ?>

                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?php echo e(Form::label('Nama customer', 'Jenis Harga:')); ?>

                                <?php echo e(Form::select('jenis_harga', $Harga, null, ['class'=> 'form-control select2','id'=>'Harga2','required', 'placeholder'=>'','style'=>'width: 100%'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    //     $.ajax({
    //         url: "<?php echo route('tarifkegiatan.selectnoncontainer'); ?>",
    //         method: 'POST',
    //         data: { _token:token},
    ...
    // }
        ...
        $(function() {
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo route('tarifkegiatan.data'); ?>',
                columns: [
        ...
        function tipe(){
            ...
            $.ajax({
                url: '<?php echo route('tarifkegiatan.tipe'); ?>',
                type: 'POST',
                data : {
                        'id': id
                },
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var id = data['id'];
                    var add = $("#addtarif").attr("href","http://localhost/gui_front_depo_laravel/admin/tarifkegiatan/"+id+"/detail");
                    $('.hapus-button').show();
                    $('.edit-button').hide();
                    $('.add-button').show();
                }
            ...
            $('#editkegiatan').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('tarifkegiatan.edit_detail'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#hapuskegiatan').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('tarifkegiatan.hapus_detail'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('tarifkegiatan.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
