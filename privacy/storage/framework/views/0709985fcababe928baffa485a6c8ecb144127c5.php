<?php $__env->startSection('title', 'Detail Tarif Kegiatan'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;">Jenis Kegiatan <b><?php echo e($tarif->kegiatan->description); ?></b></font>
    </span>
...
<div class="box box-danger">
    <div class="box-body">
        <div class="addform">
            ...
            <div class="row">
                <?php echo e(Form::hidden('id_tarif',$tarif->id, ['class'=> 'form-control','readonly','id'=>'kodekegiatan'])); ?>

                <?php echo e(Form::hidden('type_kegiatan',$tarif->type_kegiatan, ['class'=> 'form-control','readonly','id'=>'typekegiatan'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::date('tgl_berlaku', null,['class'=> 'form-control','id'=>'Tgl1','required','onchange'=>'ambiltgl();'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo e(Form::label('tipe', 'Jenis Tarif:')); ?>

                        <?php echo e(Form::select('jenis_harga', $Jenis, null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'Jenis1', 'required','onchange'=>'ambiltarif();'])); ?>
...
<?php if ($tarif->type_kegiatan == 'CFS') { ?>
<div class="col-md-6">
   <div class="box box-danger">
        <div class="box-body">
            <div class="tambahpallet">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'ADD_PALLET']); ?>

                <div class="row">
                    <?php echo e(Form::hidden('id_tarif', $tarif->id, ['class'=> 'form-control','readonly','id'=>'idtarif1'])); ?>

                    <?php echo e(Form::hidden('tgl_berlaku', null, ['class'=> 'form-control','readonly','id'=>'TglPallet1','required'])); ?>

                    <?php echo e(Form::hidden('jenis_tarif', null, ['class'=> 'form-control','readonly','id'=>'TarifPallet1','required'])); ?>

                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('tipe', 'Type Pallet:')); ?>

                            <?php echo e(Form::select('type_pallet', ['1'=>'SW','2'=>'MB'], null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'tipe1', 'required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Biaya Storage:')); ?>

                            <?php echo e(Form::text('biaya_storage', null,['class'=> 'form-control','id'=>'Biaya1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Biaya Receiving:')); ?>

                            <?php echo e(Form::text('biaya_receiving', null,['class'=> 'form-control','id'=>'Biaya2'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Biaya Delivery:')); ?>

                            <?php echo e(Form::text('biaya_delivery', null,['class'=> 'form-control','id'=>'Biaya3'])); ?>

                        </div>
                    </div>
                    <div class="col-md-12">
                        <span class="pull-right">
                            <?php echo e(Form::submit('➕ TAMBAH', ['class' => 'btn btn-success btn-xs addpallet','id'=>'submit1'])); ?>
    ...
    <div class="box box-danger">
        <div class="box-body">
            <div class="tambahalat">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'ADD_ALAT']); ?>

                <div class="row">
                    <?php echo e(Form::hidden('id_tarif', $tarif->id, ['class'=> 'form-control','readonly','id'=>'idtarif2'])); ?>

                    <?php echo e(Form::hidden('tgl_berlaku', null, ['class'=> 'form-control','readonly','id'=>'TglAlat1'])); ?>

                    <?php echo e(Form::hidden('jenis_tarif', null, ['class'=> 'form-control','readonly','id'=>'TarifAlat1'])); ?>

                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo e(Form::label('tipe', 'Type Alat:')); ?>

                            <?php echo e(Form::select('kode_alat', $Alat, null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'TypeAlat1', 'required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Biaya Per Jam:')); ?>

                            <?php echo e(Form::text('per_jam', null,['class'=> 'form-control','id'=>'PerJam1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Biaya Per Ton:')); ?>

                            <?php echo e(Form::text('per_ton', null,['class'=> 'form-control','id'=>'PerTon1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-12">
                        <span class="pull-right">
                            <?php echo e(Form::submit('➕ TAMBAH', ['class' => 'btn btn-success btn-xs addalat','id'=>'submit2'])); ?>
...
<?php }else if ($tarif->type_kegiatan == 'CONTAINER') { ?>
<div class="col-md-3">
   <div class="box box-danger">
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover" id="container-table" width="100%" style="font-size: 12px;">
                    <thead>
                        <tr class="bg-danger">
                            <th>id</th>
                            <th>id tarif</th>
...
<div class="col-md-9" id="div-size">
    <div class="box box-danger">
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover" id="size-table" width="100%" style="font-size: 12px;">
                    <thead>
                        <tr class="bg-warning">
                            <th>id</th>
                            <th>id tarif container</th>
                            <th>Kode Size</th>
                            <th>Harga Empty</th>
                            <th>Harga Loaded</th>
                        </tr>
            ...
            <div class="tambahsize">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'ADD_SIZE']); ?>

                <div class="row">
                    <?php echo e(Form::hidden('id_tarif_container', null, ['class'=> 'form-control','readonly','id'=>'idtarif1'])); ?>

                    <div class="col-md-5">
                        <div class="form-group">
                            <?php echo e(Form::label('tipe', 'Kode Size:')); ?>

                            <?php echo e(Form::select('kode_size', $Size, null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'KodeSize1', 'required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Harga Empty:')); ?>

                            <?php echo e(Form::text('harga_empty', null,['class'=> 'form-control','id'=>'Empty1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Biaya', 'Harga Loaded:')); ?>

                            <?php echo e(Form::text('harga_loaded', null,['class'=> 'form-control','id'=>'Loaded1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-12">
                        <span class="pull-right">
                            <?php echo e(Form::submit('➕ TAMBAH', ['class' => 'btn btn-success btn-xs addbutton','id'=>'submit'])); ?>

                            <button type="button" class="btn btn-info btn-xs editbutton" id="editsize" data-toggle="modal" data-target="">
                                <i class="fa fa-edit"></i> EDIT
                            </button>
                            <button type="button" class="btn btn-danger btn-xs hapusbutton" id="hapussize">
                                <i class="fa fa-times-circle"></i> HAPUS
                            </button>
                        </span>
                    </div>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        function tabel_pallet2(tgl,tarif,id){
            $.ajax({
                url: '<?php echo route('tarifkegiatan.GetDataPallet'); ?>',
                type: 'GET',
                data : {
                    'tgl_berlaku': tgl,
                    'jenis_tarif': tarif,
        ...
        function tabel_alat2(tgl,tarif,id){
            $.ajax({
                url: '<?php echo route('tarifkegiatan.GetDataAlat'); ?>',
                type: 'GET',
                data : {
                    'tgl_berlaku': tgl,
                    'jenis_tarif': tarif,
    ...
    $(function(){
        ...
        $('#container-table').DataTable({
            ...
            "bPaginate": false,
            "scrollY": 160,
            ajax:'http://localhost/gui_front_depo_laravel/admin/tarifkegiatan/getDatabyID2?id='+id_kegiatan,
    ...
    function tabel_pallet(id){
        $.ajax({
            url: '<?php echo route('tarifkegiatan.getDatabyID'); ?>',
            type: 'GET',
            data : {
                'id': id
            },
    ...
    function tabel_size(id){
        $.ajax({
            url: '<?php echo route('tarifkegiatan.getDataSize'); ?>',
            type: 'GET',
            data : {
                'id': id
            },
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#container-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-black text-bold') ) {
                    $(this).removeClass('selected bg-black text-bold');
                    $('.add-button').hide();
                    $('.hapus-button').hide();
                    ...
                    table_container.$('tr.selected').removeClass('selected bg-black text-bold');
                    $(this).addClass('selected bg-black text-bold');
                    var select = $('.selected').closest('tr');
                    var data = $('#container-table').DataTable().row(select).data();
                    closeOpenedRows(table_container, select);
                    var id = data['id'];
                    $('.add-button').show();
                    $('.hapus-button').show();
                    $('.edit-button').hide();
            ...
            $('#size-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected2 bg-black text-bold') ) {
                    $(this).removeClass('selected2 bg-black text-bold');
                    $('#KodeSize1').val('').trigger('change');
                    $('#Empty1').val('');
                    ...
                    // table.$('tr.selected').removeClass('selected bg-gray text-bold');
                    table_size.$('tr.selected2').removeClass('selected2 bg-black text-bold');
                    $(this).addClass('selected2 bg-black text-bold');
                    var select2 = $('.selected2').closest('tr');
                    var data2 = $('#size-table').DataTable().row(select2).data();
                    closeOpenedRows(table_size, select2);

                    var id2 = data2['id'];
                    var id_tarif_container = data2['id_tarif_container'];
                    var kode_size = data2['kode_size'];
                    var empty = data2['harga_empty'];
                    var loaded = data2['harga_loaded'];

                    $('#idtarif1').val(id_tarif_container);
                    $('#KodeSize1').val(kode_size).trigger('change');
                    $('#Empty1').val(empty);
                    $('#Loaded1').val(loaded);
                    $('.editbutton').show();
                    $('.hapusbutton').show();
            ...
            $('#editcfs').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('tarifkegiatan.edit_detail_cfs'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                        'id_tarif': id_tarif
            ...
            $('#hapuscfs').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('tarifkegiatan.hapus_detail_tarif'); ?>',
                            type: 'POST',
                            data : {
                                'id': id,
                                'id_tarif': id_tarif,
            ...
            $('#editalat').click( function () {
                ...
                var id_tarif_cfs = data['id_tarif_cfs'];
                var id = data['id'];
                ...
                $.ajax({
                    url: '<?php echo route('tarifkegiatan.edit_alat'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
            ...
            $('#editsize').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('tarifkegiatan.edit_size'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
            ...
            $('#hapusalat').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('tarifkegiatan.hapus_alat'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                        'id_tarif_cfs': id_tarif_cfs,
            ...
            $('#hapussize').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('tarifkegiatan.hapus_size'); ?>',
                    type: 'POST',
                    data : {
                        'id': id,
                        'id_tarif_container': id_tarif_container,
        ...
        $('#ADD_PALLET').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('tarifkegiatan.store_detail_cfs'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
            $.ajax({
                url:'<?php echo route('tarifkegiatan.ajaxupdate_detail'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#QTY2').val('');
        ...
        $('#ADD_ALAT').submit(function (e) {
            ...
            // Check if empty of not
            $.ajax({
                url:'<?php echo route('tarifkegiatan.store_detail_alat'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
        ...
        $('#ADD_SIZE').submit(function (e) {
            ...
            // Check if empty of not
            $.ajax({
                url:'<?php echo route('tarifkegiatan.store_size'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
