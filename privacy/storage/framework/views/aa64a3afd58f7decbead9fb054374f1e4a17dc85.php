                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tanggal Insentif:')); ?>
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addjo").attr("href","http://localhost/gui_front_pbm_laravel/admin/insentifoperator/"+no_insentif+"/detail");
                    var print = $("#printjr").attr("href","http://localhost/gui_front_pbm_laravel/admin/insentifoperator/exportpdf?no_insentif="+no_insentif);
                    if(status == 'POSTED'){
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
