        ...
        <br><br>
            <h1>Trucking Vendor</h1>
                <p><b>Periode: </b><?php echo ($pembayaran->tanggalkembali_dari) ?> s.d <?php echo ($pembayaran->tanggalkembali_sampai) ?> <br>
                    <b>Pemilik Mobil :</b> <?php echo e($pemilik->nama_vendor); ?> / <b>No. Transaksi :</b> <?php echo e($request); ?> / <b>Tanggal :</b> <?php echo e($pembayaran->tanggal_pembayaran); ?> / <b>Status :</b> <?php echo e($pembayaran->status); ?></p>
    </div>
