                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('harga', null, ['class'=> 'form-control','id'=>'Harga','required'=>'required', 'placeholder'=>'Harga','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('jumlah', null, ['class'=> 'form-control','id'=>'Jumlah','required'=>'required', 'placeholder'=>'Jumlah','autocomplete'=>'off'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('harga', null, ['class'=> 'form-control','id'=>'HargaP','autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('jumlah', null, ['class'=> 'form-control','id'=>'JumlahP','autocomplete'=>'off'])); ?>
