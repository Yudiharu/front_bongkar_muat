<?php $__env->startSection('title', 'Tarif Umum'); ?>
    ...
    <div class="box-body">
        <div class="addform">
            ...
            <?php if ($Tarif != null) { ?>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::date('tgl_berlaku', $Tarif->tgl_berlaku,['class'=> 'form-control','id'=>'Tgl1','required'])); ?>

                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo e(Form::label('Biaya', 'Biaya Admin:')); ?>

                        <?php echo e(Form::text('biaya_admin', $Tarif->biaya_admin,['class'=> 'form-control','id'=>'Admin1'])); ?>

                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo e(Form::label('Biaya', 'Biaya Pass Tongkang:')); ?>

                        <?php echo e(Form::text('biaya_pass_tongkang', $Tarif->biaya_pass_tongkang,['class'=> 'form-control','id'=>'Tongkang1'])); ?>

                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo e(Form::label('Biaya', 'Biaya Pass Truck:')); ?>

                        <?php echo e(Form::text('biaya_pass_truck', $Tarif->biaya_pass_truck,['class'=> 'form-control','id'=>'Truck1'])); ?>

                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <?php echo e(Form::label('Biaya', 'Biaya Penumpukan CFS:')); ?>

                        <?php echo e(Form::text('biaya_penumpukan_cfs', $Tarif->biaya_penumpukan_cfs,['class'=> 'form-control','id'=>'Cfs1'])); ?>
            ...
            <?php } else { ?>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::date('tgl_berlaku', null,['class'=> 'form-control','id'=>'Tgl1','required'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('biaya_admin', null,['class'=> 'form-control','id'=>'Admin1'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('biaya_pass_tongkang', null,['class'=> 'form-control','id'=>'Tongkang1'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('biaya_pass_truck', null,['class'=> 'form-control','id'=>'Truck1'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::text('biaya_penumpukan_cfs', null,['class'=> 'form-control','id'=>'Cfs1'])); ?>
            ...
            <?php } ?>
                <div class="col-md-2">
                    <br>
                    <?php echo e(Form::submit('➕ SIMPAN/UPDATE', ['class' => 'btn btn-success btn-sm','style'=>'height: 40px;','id'=>'submit'])); ?>
...
<div class="col-md-12" id="tabelbiaya2">
   <div class="box box-danger">
        <div class="box-body">
            <div class="row">
                <div class="col-md-2">
                    <?php echo e(Form::label('Biaya', 'Daftar Biaya Umum:')); ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="box-body"> 
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('labels', 'History Biaya Umum:')); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        $(function(){
            $('#data2-table').DataTable({
                ...
                "bPaginate": true,
                // "scrollY": 160,
                ajax:'<?php echo route('tarifumum.getDatabyID'); ?>',
                columns: [
            ...
            $('#data3-table').DataTable({
                ...
                "bPaginate": false,
                "scrollY": 160,
                ajax:'<?php echo route('tarifumum.getDatabyID2'); ?>',
                columns: [
                    { data: 'id', name: 'id', visible: false},
                    { data: 'tgl_berlaku', name: 'tgl_berlaku' },
                    { data: 'biaya_admin', name: 'biaya_admin' },
    ...
    <script>
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('tarifumum.store_tarif'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#hapuscfs').click( function () {
            ...
            swal({
                ...
                if (e.value === true) {
                    $.ajax({
                        url: '<?php echo route('tarifumum.hapus_tarif'); ?>',
                        type: 'POST',
                        data : {
                            'id': id,
                        },
