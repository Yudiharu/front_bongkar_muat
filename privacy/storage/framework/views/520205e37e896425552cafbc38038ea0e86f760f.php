                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type_jo', $TypeJo->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'TypeJO1','required','onchange'=>"cekjenis();"])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('kode_consignee',null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Consignee2'])); ?>
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addjo").attr("href","https://aplikasi.gui-group.co.id/gui_front_02_trial/admin/joborder/"+no_joborder+"/detail");
                    var add2 = $("#addjor").attr("href","https://aplikasi.gui-group.co.id/gui_front_02_trial/admin/joborder/"+no_joborder+"/detail2");
                    var print = $("#printjr").attr("href","https://aplikasi.gui-group.co.id/gui_front_02_trial/admin/joborder/exportpdf?no_joborder="+no_joborder);
                    var printjr = $("#printjrequest").attr("href","https://aplikasi.gui-group.co.id/gui_front_02_trial/admin/joborder/exportpdf2?no_joborder="+no_joborder);
                    if(status == '2' && type != '4'){
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.add-button').hide();
