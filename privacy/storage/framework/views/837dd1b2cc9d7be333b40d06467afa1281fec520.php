...
<?php $__env->startSection('title', 'Helper'); ?>
...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-helper')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo e(Form::label('Nama', 'Nama Helper:')); ?>

                                    <?php echo e(Form::text('nama_helper', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Helper','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('nix', 'NIK:')); ?>

                                    <?php echo e(Form::text('nik', null, ['class'=> 'form-control','id'=>'Nik1', 'placeholder'=>'No. Induk','autocomplete'=>'off','required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('bankss', 'Bank:')); ?>

                                    <?php echo e(Form::select('kode_bank',$Bank->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Bank1'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_rekening', null, ['class'=> 'form-control','id'=>'Rek1', 'placeholder'=>'No. Rekening','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
            ...
            <?php echo Form::open(['id'=>'EDIT']); ?>
                ...
                <div class="modal-body">
                        ...
                        <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly'])); ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo e(Form::label('nama_sopir', 'Nama Helper:')); ?>

                                    <?php echo e(Form::text('nama_helper', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required', 'placeholder'=>'Nama Helper','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nik', null, ['class'=> 'form-control','id'=>'Nik2', 'placeholder'=>'No. Induk','autocomplete'=>'off','required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_bank',$Bank->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Bank2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('status',['Aktif' => 'Aktif','NonAktif' => 'NonAktif'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Status2','required','onchange'=>"cekstat();"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('keterangan', null, ['class'=> 'form-control','id'=>'Ket2','required', 'placeholder'=>'','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-helper')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-helper')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    function cekstat(){
        ...
        if (stat == 'NonAktif'){
            ...
            document.getElementById("Ket2").required = true;
        }else {
            $('#Ket2').val('');
            document.getElementById("Ket2").readOnly = true;
            document.getElementById("Ket2").required = false;
        }
    }
    ...
    $(function() {   
        $('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('helper.data'); ?>',
        ...
        $(document).ready(function(){
            ...
            $('#edithelper').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('helper.edit_helper'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_sopir
                    },
            ...
            $('#hapushelper').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('helper.hapus_helper'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_sopir
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('helper.store'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
            $.ajax({
                url:'<?php echo route('helper.ajaxupdate'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
