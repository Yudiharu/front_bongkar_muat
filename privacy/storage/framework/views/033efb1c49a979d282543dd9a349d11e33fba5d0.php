...
<?php $__env->startSection('title', 'Trucking Vendor Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Trucking Vendor <b><?php echo e($pembayaran->no_pembayaran); ?></b></font>
    </span>
                        ...
                        <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_pembayaran',$pembayaran->no_pembayaran, ['class'=> 'form-control','readonly','id'=>'nopembayaran'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::hidden('kode_pemilik',$pembayaran->kode_pemilik, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'kode_pemilik','required','readonly'])); ?>

                                        
                                        <?php echo e(Form::text('nama_pemilik',$nama_pemilik, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'nama_pemilik','required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tanggalkembali_dari',$pembayaran->tanggalkembali_dari,['class'=> 'form-control','id'=>'dari' ,'required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tanggalkembali_sampai',$pembayaran->tanggalkembali_sampai,['class'=> 'form-control','id'=>'sampai' ,'required','readonly'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/pembayarandetail/getDatabyID?id='+no_pembayaran,
        ...
        $(document).ready(function() {
            ...
            $('#hapuspembayaran').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('pembayarandetail.hapus_pembayaran'); ?>',
                            type: 'POST',
                            data : {
        ...
        function getspb()
        {
            ...
            var sampai = $('#sampai').val();
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('pembayarandetail.getspb'); ?>',
                            type: 'POST',
                            data : {
                                'no_pembayaran': no_pembayaran,
        ...
        function hapus() {
            ...
            if (e.value === true) {
                $.ajax({
                    url:'<?php echo route('pembayarandetail.hapusall'); ?>',
                    type:'POST',
                    data : {
                            'id': no_pembayaran
                        },
