                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group19">
                                    <?php echo e(Form::label('tipe', 'Type:')); ?>

                                    <?php echo e(Form::select('tipe', ['Shipping' => 'Shipping', 'EMKL' => 'EMKL', 'PBM' => 'PBM', 'MLO' => 'MLO', 'Lainnya' => 'Lainnya'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'tipe1','required'=>'required'])); ?>
