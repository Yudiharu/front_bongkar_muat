<?php $__env->startSection('title', 'SPB Non Container'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('no_spbnonmanual', 'SPB Manual:')); ?>

                                    <?php echo e(Form::text('no_spbnonmanual', null, ['class'=> 'form-control','id'=>'Manual1', 'placeholder'=>'No SPB Manual', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tgl_spbnon', 'Tanggal SPB:')); ?>

                                    <?php echo e(Form::date('tgl_spbnon', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tarif_gajisopir', 'Tarif Gaji:')); ?>

                                    <?php echo e(Form::text('tarif_gajisopir', null, ['class'=> 'form-control','id'=>'Gaji1', 'placeholder'=>'Tarif Gaji', 'autocomplete'=>'off','required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('dari',$Port->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Dari1','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('tujuan',$Port->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Tujuan1','required'=>'required'])); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_spbnon', null, ['class'=> 'form-control','id'=>'Spb','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_spbnonmanual', null, ['class'=> 'form-control','id'=>'Manual', 'placeholder'=>'No SPB Manual', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tgl_spbnon', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('tarif_gajisopir', null, ['class'=> 'form-control','id'=>'Gaji', 'placeholder'=>'Tarif Gaji', 'autocomplete'=>'off','required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('dari',$Port->sort(),null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Dari','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('tujuan',$Port->sort(),null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Tujuan','required'=>'required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('spbnon.data'); ?>',
            columns: [
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addpembelian").attr("href","http://localhost/gui_front_emkl_laravel/admin/spbnon/"+no_spbnon+"/detail");
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('spbnon.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_spbnon
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('spbnon.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_spbnon
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('spbnon.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_spbnon
                    },
            ...
            $('#editspbnon').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('spbnon.edit_spbnon'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_spbnon
                    },
            ...
            $('#hapusspbnon').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('spbnon.hapus_spbnon'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_spbnon
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('spbnon.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('spbnon.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
