                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('pekerjaan',null, ['class'=> 'form-control','id'=>'Pekerjaan1','autocomplete'=>'off','rows'=>'2'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('pekerjaan',null, ['class'=> 'form-control','id'=>'Pekerjaan2','autocomplete'=>'off','rows'=>'2'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_pbm_laravel/admin/pemakaianalatdetail/getDatabyID?id='+no_pemakaian,
