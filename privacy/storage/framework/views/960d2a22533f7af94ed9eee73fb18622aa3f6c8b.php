...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Pemilik <b><?php echo e($pemilik->nama_pemilik); ?></b></font>
    </span>
            ...
            <div class="addform">
                    ...
                    <?php echo Form::open(['id'=>'ADD_DETAIL']); ?>
                      ...
                      <center><kbd>ADD FORM</kbd></center><br>
                        <div class="row">
                                <?php echo e(Form::hidden('kode_pemilik',$pemilik->id, ['class'=> 'form-control','readonly','id'=>'kodepemilik'])); ?>
                            ...
                            <div class="row">   
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('kode_pemilik',$pemilik->id, ['class'=> 'form-control','readonly','id'=>'kodepemilik2'])); ?>
