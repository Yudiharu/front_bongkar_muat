                        ...
                        <div class="row">
                                ...
                                <!-- <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_spb_manual',null, ['class'=> 'form-control','required','id'=>'manual1'])); ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::date('tgl_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required','onchange'=>"tgl();",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Tanggal SPB tidak boleh lebih dari tanggal kembali.",'readonly'])); ?>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group2">
                                            ...
                                            <?php echo e(Form::text('sopir',null, ['class'=> 'form-control','id'=>'Namasopir1','readonly'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group13">
                                            ...
                                            <?php echo e(Form::text('no_spb_manual',null, ['class'=> 'form-control','required','id'=>'Manual','readonly'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group16">
                                            ...
                                            <?php echo e(Form::text('kode_mobil',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Mobil','required'=>'required','readonly'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group3">
                                            ...
                                            <?php echo e(Form::text('kode_sopir',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Sopir','readonly'])); ?>
                                        ...
                                        <div class="form-group4">
                                            ...
                                            <?php echo e(Form::text('sopir',null, ['class'=> 'form-control','id'=>'Namasopir','readonly'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#data2-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var tgl = select.find('td:eq(2)').text();
                    if(tgl == 'Not set'){
                        $('.edit-button').hide();
                    }else{
                        $('.edit-button').show();
        ...
        function back(){
            ...
            window.location.replace("http://localhost/gui_front_emkl_laravel/admin/trucking/"+notrucking+"/detail3");
        }
