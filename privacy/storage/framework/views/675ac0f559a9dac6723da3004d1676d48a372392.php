...
<?php $__env->startSection('title', 'Trucking'); ?>
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addtruckingnon").attr("href","https://aplikasi.gui-group.co.id/gui_front_02_trial/admin/truckingnon/"+no_truckingnon+"/detail");
                    var print = $("#printtruckingnon").attr("href","https://aplikasi.gui-group.co.id/gui_front_02_trial/admin/truckingnon/export2?no_truckingnon="+no_truckingnon);
