...
<?php $__env->startSection('title', 'Pemakaian Alat Berat'); ?>
        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-pemakaianalatberat')) : ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tgl Pemakaian:')); ?>

                            <?php echo e(Form::date('tgl_pemakaian', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('customers', 'No JO:')); ?>

                            <?php echo e(Form::select('no_joborder',$Joborder->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'NoJO1','required','onchange'=>"getjo()"])); ?>

                        </div>
                    </div>
                    <?php echo e(Form::hidden('kode_customer',null, ['class'=> 'form-control','id'=>'sKodeCust1','readonly'])); ?>

                    <?php echo e(Form::hidden('type_jo',null, ['class'=> 'form-control','id'=>'sTypeJO1','readonly'])); ?>

                    <?php echo e(Form::hidden('type_kegiatan',null, ['class'=> 'form-control','id'=>'sTypeKegiatan1','readonly'])); ?>

                    <?php echo e(Form::hidden('status_lokasi',null, ['class'=> 'form-control','id'=>'sLokasi1','readonly'])); ?>

                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama', 'Nama Customer:')); ?>

                            <?php echo e(Form::text('nama_customer', null, ['class'=> 'form-control','id'=>'KodeCust1', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('TIpeJO', 'Type JO:')); ?>

                            <?php echo e(Form::text('tipe_jo', null, ['class'=> 'form-control','id'=>'TypeJO1', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Kegiatan', 'Type Kegiatan:')); ?>

                            <?php echo e(Form::text('tipe_kegiatan', null, ['class'=> 'form-control','id'=>'TypeKegiatan1', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('bongkar', 'Status Lokasi:')); ?>

                            <?php echo e(Form::text('stat_lokasi', null, ['class'=> 'form-control','id'=>'Lokasi1', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>
    ...
    <div class="modal-dialog" role="document">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::date('tgl_pemakaian', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal2' ,'required'=>'required'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('no_joborder',$Joborder->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'NoJO2','required','onchange'=>"getjo2()"])); ?>

                        </div>
                    </div>
                    <?php echo e(Form::hidden('kode_customer',null, ['class'=> 'form-control','id'=>'sKodeCust2','readonly'])); ?>

                    <?php echo e(Form::hidden('type_jo',null, ['class'=> 'form-control','id'=>'sTypeJO2','readonly'])); ?>

                    <?php echo e(Form::hidden('type_kegiatan',null, ['class'=> 'form-control','id'=>'sTypeKegiatan2','readonly'])); ?>

                    <?php echo e(Form::hidden('status_lokasi',null, ['class'=> 'form-control','id'=>'sLokasi2','readonly'])); ?>

                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Nama', 'Nama Customer:')); ?>

                            <?php echo e(Form::text('nama_customer', null, ['class'=> 'form-control','id'=>'KodeCust2', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('tipe_jo', null, ['class'=> 'form-control','id'=>'TypeJO2', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('tipe_kegiatan', null, ['class'=> 'form-control','id'=>'TypeKegiatan2', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('stat_lokasi', null, ['class'=> 'form-control','id'=>'Lokasi2', 'placeholder'=>'', 'autocomplete'=>'off','readonly'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-pemakaianalatberat')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-pemakaianalatberat')) : ?>
            ...
            <?php if (app('laratrust')->can('add-pemakaianalatberat')) : ?>
            ...
            <?php if (app('laratrust')->can('print-pemakaianalatberat')) : ?>
...
<?php $__env->startPush('js'); ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('pemakaianalat.getkode'); ?>',
                        type:'POST',
    ...
    function getjo(){
        var no_jo = $('#NoJO1').val();
        $.ajax({
            url:'<?php echo route('pemakaianalat.getjo'); ?>',
            type:'POST',
            data : {
                'no_jo': no_jo,
            },
    ...
    function getjo2(){
        var no_jo = $('#NoJO2').val();
        $.ajax({
            url:'<?php echo route('pemakaianalat.getjo2'); ?>',
            type:'POST',
            data : {
                'no_jo': no_jo,
            },
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            "pageLength":100,
            "order": [[0, "desc"]],
            ajax: '<?php echo route('pemakaianalat.data'); ?>',
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('pemakaianalat.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_pemakaian
                        },
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('pemakaianalat.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pemakaian
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('pemakaianalat.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_joborder
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('pemakaianalat.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_pemakaian
                    },
            ...
            $('#button6').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('pemakaianalat.showdetailjor'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_joborder
                    },
            ...
            $('#editjoborder').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('pemakaianalat.edit_pemakaian'); ?>',
                    type: 'POST',
                    data : {
            ...
            $('#hapusjoborder').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('pemakaianalat.hapus_pemakaian'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pemakaian
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('pemakaianalat.store'); ?>',
                type:'POST',
                data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('pemakaianalat.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
