...
<head>
    ...
    <br>
    <title>PSA ~ <?php echo e($request); ?></title>
    <style>
        @page  {
...
<hr>
    <section class="list-item">
        <table class="grid" style="font-size: 9pt; width: 1000px;" border="0" >
            <thead>
            <tr >
                <th style="text-align: left; width: 70px;">Operator</th>
                <th style="width: 60px; text-align: left;">Helper1</th>
                <th style="width: 60px; text-align: left;">Helper2</th>
                <th style="width: 120px; text-align: left;">Pekerjaan</th>
...
?>
        <table class="grid" style="font-size: 9pt; width: 1000px;" border="0" >
            ...
            <?php foreach ($jobrequest as $key => $row): ?>
                ...
                ?>
                <tr>
                    <th style="text-align: left; font-weight: normal; width: 70px; word-spacing: -2px;"><?php echo $opera->nama_operator; ?></th>
                    ...
                    <th style="font-weight: normal; width: 120px; text-align: left; word-spacing: -2px;"><?php echo $row->pekerjaan; ?></th>
