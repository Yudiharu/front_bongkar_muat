...
<?php $__env->startSection('title', 'Permintaan Kasbon'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('Tanggal Permintaan', 'Tanggal PKB:')); ?>

                                    <?php echo e(Form::date('tanggal_permintaan', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tglpkb1','required'=>'required'])); ?>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('pemohon', 'Nama Pemohon:')); ?>

                                    <?php echo e(Form::text('nama_pemohon', null, ['class'=>'form-control','id'=>'Nama1','style'=>'width: 100%','placeholder'=>'','onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <!-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_journal', null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'nojurnal','required','readonly'])); ?>

                                </div>
                            </div> -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('nilaii', 'Jumlah Nominal:')); ?>

                                    <?php echo e(Form::text('nilai', null, ['class'=>'form-control','id'=>'Nilai1','style'=>'width: 100%','placeholder' => '','onkeypress'=>"return hanyaAngka(event)"])); ?>

                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo e(Form::label('ket', 'Keterangan:')); ?>

                                    <?php echo e(Form::text('keterangan',null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'Ket1','required','autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <?php echo Form::open(['id'=>'EDIT']); ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <?php echo e(Form::hidden('no_pkb',null, ['class'=> 'form-control','readonly','id'=>'nopkb'])); ?>

                        <div class="col-md-4">
                            <div class="form-group">
                                <?php echo e(Form::label('Tanggal', 'Tanggal PKB:')); ?>

                                <?php echo e(Form::date('tanggal_permintaan', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tglpkb2','required'=>'required'])); ?>

                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <?php echo e(Form::label('nama', 'Nama Pemohon:')); ?>

                                <?php echo e(Form::text('nama_pemohon', null, ['class'=>'form-control','id'=>'Nama2','style'=>'width: 100%','placeholder'=>''])); ?>

                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <?php echo e(Form::label('nilaii2', 'Jumlah Nominal:')); ?>

                                <?php echo e(Form::text('nilai', null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'Nilai2','required','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('keterangan',null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'Ket2','required','autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function header(){
            $.ajax({
                url: '<?php echo route('kasbon.data'); ?>',
                type: 'GET',
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var print = $("#printkasbon").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/kasbon/exportpdf?no_pkb="+no_pkb);
                    if(status == 'POSTED'){
                        $('.tombol1').hide();
                        $('.tombol2').show();
                        $('.tombol3').show();
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('kasbon.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pkb
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('kasbon.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pkb
                            },
            ...
            $('#button3').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('kasbon.approve'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pkb
                            },
            ...
            $('#editpkb').click( function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo route('kasbon.edit_kasbon'); ?>',
                    data: {'id': no_pkb },
                    dataType: 'JSON',
            ...
            $('#hapuspkb').click( function () {
                ...
                if (e.value === true) {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo route('kasbon.hapus_kasbon'); ?>',
                        data: {'id': no_pkb },
                        dataType: 'JSON',
                        success: function (results) {
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('kasbon.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('kasbon.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
