        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <a href="#" id="addjor"><button type="button" class="btn bg-orange btn-xs add2-button" data-toggle="modal" data-target=""><i class="fa fa-book">&nbsp;</i>DETAIL SPK</button></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type_jo', $TypeJo->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'TypeJO1','required'])); ?>

                        </div>
                    </div>
                    <!--<div class="col-md-4">-->
                    <!--    <div class="form-group">-->
                    <!--        <?php echo e(Form::label('bongkar', 'No SPK:')); ?>-->
                    <!--        <?php echo e(Form::text('no_spk', null, ['class'=> 'form-control','id'=>'NoSpk1', 'placeholder'=>'', 'autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>-->
                    <!--    </div>-->
                    <!--</div>-->
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kode_customer',$Customer->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Customer1'])); ?>

                        </div>
                        <!--<div class="form-group-custinf">-->
                        <!--    <?php echo e(Form::label('customers', 'Nama Customer:')); ?>-->
                        <!--    <?php echo e(Form::select('kode_customer',$CustomerInf->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'CustomerInf1'])); ?>-->
                        <!--</div>-->
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('cons', 'Remark:')); ?>

                            <?php echo e(Form::text('kode_consignee',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Consignee1'])); ?>
                    ...
                    <!--<?php echo e(Form::hidden('type_kegiatan', '1', ['class'=> 'form-control','id'=>'Kegiatan1','readonly'])); ?>-->
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('bongkar', 'PIC Foreman:')); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('loks', 'Lokasi Kegiatan:')); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('reffs', 'No. Kontrak:')); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggals', 'Tgl Kontrak:')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type_jo', $TypeJo->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'TypeJO2','required'=>'required'])); ?>
                    ...
                    <!--    <div class="form-group">-->
                    <!--        <?php echo e(Form::label('bongkar', 'No SPK:')); ?>-->
                    <!--        <?php echo e(Form::text('no_spk', null, ['class'=> 'form-control','id'=>'NoSpk2', 'placeholder'=>'', 'autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('kode_consignee',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Consignee2'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">      
        ...
        // function cekjenis(){
        //     var jenis = $("#TypeJO1").val();
        //     if (jenis == '3') {
        //         $('.form-group-custinf').show();
        //         $('.form-group-cust').hide();
        //         $("#Customer1").val('').trigger('change');
        //     }else {
        //         $('.form-group-custinf').hide();
        //         $('.form-group-cust').show();
        //         $("#CustomerInf1").val('').trigger('change');
        //     }
        // }
        ...
        $(function() {          
            ...
            fnRowCallback: function (row, data, iDisplayIndex, iDisplayIndexFull) {
                if (data['status'] == "1") {
                    ...
                    $('td', row).css('background-color', '#FFF1D3');
                }
            },
            columns: [
                ...
                { data: 'no_spk', name: 'no_spk', visible: false },
                { data: 'customer1.nama_customer', "defaultContent": "<i>Not set</i>" },
                { data: 'kode_consignee', name: 'kode_consignee' },
                { data: 'kode_vendor', "defaultContent": "<i>Not set</i>" },
        ...
        $(document).ready(function(){   
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add2 = $("#addjor").attr("href",window.location.href+"/"+no_joborder+"/detail3");
                    ...
                    $.ajax({
                        url: '<?php echo route('joborder.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_joborder
                        },
            ...
            $(document).on('click', '#btn-save', function() {
                ...
                var no_joborder = data['no_joborder'];
                $.ajax({
                    url: '<?php echo route('joborder.ttd_buat'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_joborder,
                        'img': img,
            ...
            $(document).on('click', '#btn-periksa', function() {
                ...
                var no_joborder = data['no_joborder'];
                $.ajax({
                    url: '<?php echo route('joborder.ttd_periksa'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_joborder,
                        'img': img,
