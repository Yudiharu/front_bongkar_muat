                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('jenis_jo', ['SEMUA'=>'SEMUA', 'Container' => 'Container','Non-Container' => 'Non-Container'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'jen1','required'])); ?>
