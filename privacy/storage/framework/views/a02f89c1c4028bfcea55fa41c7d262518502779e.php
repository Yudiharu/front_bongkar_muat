...
<?php $__env->startSection('title', 'Trucking Vendor'); ?>
        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-pembayaran')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tanggal_pembayaran', 'Tanggal Transaksi:')); ?>

                                    <?php echo e(Form::date('tanggal_pembayaran', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('kode_pemilik', 'Pemilik Mobil:')); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tanggalkembali_dari', 'Tgl SPB Kembali (Dari):')); ?>

                                    <?php echo e(Form::date('tanggalkembali_dari', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Dari1' ,'required'=>'required'])); ?>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('tanggalkembali_sampai', 'Tgl SPB Kembali (Sampai):')); ?>

                                    <?php echo e(Form::date('tanggalkembali_sampai', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Sampai1' ,'required'=>'required'])); ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
            ...
            <?php echo Form::open(['id'=>'EDIT']); ?>
                ...
                <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('no_pembayaran', 'No Transaksi:')); ?>

                                    <?php echo e(Form::text('no_pembayaran', null, ['class'=> 'form-control','id'=>'Pembayaran','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggal_pembayaran', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_pemilik',$Pemilik->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Pemilik','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggalkembali_dari', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Dari' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tanggalkembali_sampai', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Sampai' ,'required'=>'required'])); ?>
        ...
        <div class="box box-solid">
            <div class="modal fade" id="cetakpembayaran"  role="dialog">
                <div class="modal-dialog modal-md" role="document">
                  <div class="modal-content">
                    <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo Form::open(['route' => ['pembayaran.export2'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>

                            <div class="modal-body">
                                <div class="row">
                                    <?php echo e(Form::hidden('no_pembayaran',null, ['class'=> 'form-control','id'=>'no_pembayaran'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-pembayaran')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-pembayaran')) : ?>
            ...
            <?php if (app('laratrust')->can('add-pembayaran')) : ?>
...
<?php $__env->startPush('js'); ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('pembayaran.getkode'); ?>',
                        type:'POST',
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('pembayaran.data'); ?>',
        ...
        $(document).ready(function(){
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = colom;
                    var item = colom2;
                    var add = $("#addpembayaran").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/pembayaran/"+no_pembayaran+"/detail");
                    var print = $("#printpembayaran").attr("href","https://aplikasi.gui-group.co.id/gui_front_emkl_laravel/admin/pembayaran/export2?no_pembayaran="+no_pembayaran);
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('pembayaran.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembayaran
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('pembayaran.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembayaran
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('pembayaran.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_pembayaran
                    },
            ...
            $('#editpembayaran').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('pembayaran.edit_pembayaran'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_pembayaran
                    },
            ...
            $('#hapuspembayaran').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('pembayaran.hapus_pembayaran'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembayaran
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('pembayaran.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('pembayaran.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
