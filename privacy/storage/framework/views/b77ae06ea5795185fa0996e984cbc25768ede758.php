<?php $__env->startSection('title', 'Membership Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Member <b><?php echo e($member->nama_customer); ?></b></font>
    </span>
...
<div class="box box-danger">
    <div class="box-body"> 
        <div class="addform">
            ...
            <div class="row">
                <?php echo e(Form::hidden('kode_customer',$member->id, ['class'=> 'form-control','readonly','id'=>'kodecustomer'])); ?>

                <?php echo e(Form::hidden('id_header',$member->id, ['class'=> 'form-control','readonly','id'=>'idheader'])); ?>

                <?php echo e(Form::hidden('tgl_akhir_alfi', null, ['class'=> 'form-control','readonly','id'=>'Alfi2'])); ?>

                <?php echo e(Form::hidden('tgl_akhir_apbmi', null, ['class'=> 'form-control','readonly','id'=>'Apbmi2'])); ?>

                    <!-- <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('kode_mobil', 'Membership:')); ?>

                            <?php echo e(Form::select('tipe',['ALFI'=>'ALFI','APBMI'=>'APBMI'],null,
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo e(Form::label('Alfi', 'Tanggal Aktif ALFI:')); ?>

                        <?php echo e(Form::date('tgl_aktif_alfi', null,['class'=> 'form-control','id'=>'Alfi1','onchange'=>"hitung();"])); ?>

                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo e(Form::label('Alfi', 'Tanggal Aktif APBMI:')); ?>

                        <?php echo e(Form::date('tgl_aktif_apbmi', null,['class'=> 'form-control','id'=>'Apbmi1','onchange'=>"hitung();"])); ?>
        ...
        <div class="editform">
            ...
            <div class="row">
                ...
                <?php echo e(Form::hidden('kode_customer', null, ['class'=> 'form-control','readonly','id'=>'kodecustomer2'])); ?>

                <?php echo e(Form::hidden('id_header',$member->id, ['class'=> 'form-control','readonly','id'=>'idheader2'])); ?>

                <?php echo e(Form::hidden('tgl_akhir_alfi', null, ['class'=> 'form-control','readonly','id'=>'Alfiedit2'])); ?>

                <?php echo e(Form::hidden('tgl_akhir_apbmi', null, ['class'=> 'form-control','readonly','id'=>'Apbmiedit2'])); ?>

                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo e(Form::label('Alfi', 'Tanggal Aktif ALFI:')); ?>

                        <?php echo e(Form::date('tgl_aktif_alfi', null,['class'=> 'form-control','id'=>'Alfiedit1','onchange'=>"hitung2();"])); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo e(Form::date('tgl_aktif_apbmi', null,['class'=> 'form-control','id'=>'Apbmiedit1','onchange'=>"hitung2();"])); ?><br>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        function getjenis(){
            ...
            $.ajax({
                url:'<?php echo route('pemilikdetail.getjenis'); ?>',
                type:'POST',
                data : {
                        'id': kode_mobil,
                    },
        ...
        function getjenis2(){
            ...
            $.ajax({
                url:'<?php echo route('pemilikdetail.getjenis2'); ?>',
                type:'POST',
                data : {
                        'id': kode_mobil,
                    },
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_front_depo_laravel/admin/membershipcustomer/getDatabyID?id='+kode_customer,
    ...
    <script>
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('membershipcustomer.store_detail'); ?>',
                    type:'POST',
                    data:formData,
