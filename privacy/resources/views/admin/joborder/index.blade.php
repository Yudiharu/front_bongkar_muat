            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <!--    {{ Form::label('customers', 'Nama Customer:') }}-->
                        <!--    {{ Form::select('kode_customer',$CustomerInf->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'CustomerInf1']) }}-->
                        <!--</div>-->
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <!--{{ Form::hidden('type_kegiatan', '1', ['class'=> 'form-control','id'=>'Kegiatan1','readonly']) }}-->
                    <div class="col-md-4">
                        <div class="form-group">
