                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-3">
                                <div class="form-group19">
                                    {{ Form::label('tipe', 'Jenis Harga:') }}
                                    {{Form::select('jenis_harga', $Jenis, null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'tipe1', 'required'])}}
                                </div>
                            </div> -->
                            <div class="col-md-12">
                                <div class="form-group">
                ...
                <div class="modal-body">
                        <div class="row">
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('tipe', 'Jenis Harga:') }}
                                    {{Form::select('jenis_harga', $Jenis, null, ['class'=> 'form-control select2', 'style'=>'width: 100%', 'placeholder' => '', 'id'=>'tipe2', 'required'])}}
                                </div>
                            </div> -->
                            <div class="col-md-12">
                                <div class="form-group">
