                        ...
                        {{ Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly']) }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('status',['Aktif' => 'Aktif','NonAktif' => 'NonAktif'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Status2','required','onchange'=>"cekstat();"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('Kets', 'Keterangan:') }}
                                    {{ Form::text('keterangan', null, ['class'=> 'form-control','id'=>'Ket2','required', 'placeholder'=>'','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                    </div>
                </div>
