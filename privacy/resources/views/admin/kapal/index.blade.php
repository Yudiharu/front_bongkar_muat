                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('nama_kapal', null, ['class'=> 'form-control','id'=>'Nama1', 'placeholder'=>'Nama kapal','required', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('type', ['MV'=>'MV','KM'=>'KM','LCT'=>'LCT','MT'=>'MT','Tug Boat'=>'Tug Boat','Tongkang'=>'Tongkang'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nama3']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('tahun', 'Tahun:') }}
                                    {{ Form::selectYear('tahun', 2000, 2040, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => 'Pilih Tahun','id'=>'Nama4','required'=>'required', 'autocomplete'=>''])}}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('Nomoor', 'No Aset Kapal:') }}
                                    {{ Form::text('no_asset_kapal', null, ['class'=> 'form-control','id'=>'Aset1', 'placeholder'=>'No.Aset','required', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Type', 'Tipe Kapal:',['class'=>'control-label']) }}
                            {{ Form::select('type', ['MV'=>'MV','KM'=>'KM','LCT'=>'LCT','MT'=>'MT','Tug Boat'=>'Tug Boat','Tongkang'=>'Tongkang'],null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Tipe2']) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('tahun', 'Tahun:') }}
                            {{ Form::selectYear('tahun', 2000, 2040, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => 'Pilih Tahun','id'=>'Tahun','required'=>'required', 'autocomplete'=>'off'])}}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Nomoor', 'No Aset Kapal:') }}
                            {{ Form::text('no_asset_kapal', null, ['class'=> 'form-control','id'=>'Aset2', 'placeholder'=>'No.Aset','required', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                        </div>
                    </div>
                </div>
            </div>
