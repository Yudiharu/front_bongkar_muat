            ...
            <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            {{ Form::label('qtys', 'Qty:') }}
                            {{ Form::text('qty',null, ['class'=> 'form-control','id'=>'Qty1','required','autocomplete'=>'off','oninput'=>"validate(this)",'onkeypress'=>"return hanyaAngka(event)"]) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
            ...
            <div class="editform">
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            {{ Form::label('qtys', 'Qty:') }}
                            {{ Form::text('qty',null, ['class'=> 'form-control','id'=>'Qty2','required','autocomplete'=>'off', 'onkeypress'=>"return hanyaAngka(event)"]) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
