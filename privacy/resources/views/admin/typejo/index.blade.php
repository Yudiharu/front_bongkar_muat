                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            {{ Form::label('nama_transaksi', 'Deskripsi:') }}
                            {{ Form::text('description', null, ['class'=> 'form-control','id'=>'Desc1','required'=>'required', 'placeholder'=>'Desc','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    {{ Form::label('nama_transaksi', 'Deskripsi:') }}
                    {{ Form::text('description', null, ['class'=> 'form-control','id'=>'Desc2','required'=>'required', 'placeholder'=>'Desc','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                </div>
            </div>
        </div>
    </div>
      ...
      tecla = (document.all) ? e.keyCode : e.which;
        ...
        $(document).ready(function() {
            ...
            $('#edittransaksisetup').click( function () {
                ...
                $.ajax({
                    url: '{!! route('typejo.edit_transaksisetup') !!}',
                    type: 'POST',
                    data : {
                        'id': kode_setup
                    },
            ...
            $('#hapustransaksisetup').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('typejo.hapus_transaksisetup') !!}',
                            type: 'POST',
                            data : {
                                'id': kode_setup
                            },
