...
<div class="left">
    <img src="{{ asset('css/logo_gui.png') }}" alt="" height="30px" width="30px" align="left">
    ...
    <div class="left">
        <table width="60%" style="border-spacing: 0 15px; font-size: 10pt" border="0">
            <tr >
                ...
                <td style="width: 240px">{{ $request }}</td>
            </tr>
            <tr>
                <td>Tgl SPK</td>
                <td>:</td>
        ...
        <?php }else { ?>
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $mobil->no_asset_mobil }}</td>
            </tr>
        <?php } ?>
            <tr>
                <td>Periode Kerja</td>
                <td>:</td>
                <td>{{ $spk->tgl_mulai }}&nbsp;s/d&nbsp;{{ $spk->tgl_selesai }}</td>
            </tr>
            <tr>
                <td>No. Job Order</td>
                <td>:</td>
                <td>{{ $spk->no_joborder }}</td>
            </tr>
            <tr><td><br></td></tr>
            <tr>
