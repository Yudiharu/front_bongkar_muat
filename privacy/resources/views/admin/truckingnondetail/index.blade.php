                        ...
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group1">
                                        ...
                                        {{ Form::date('tanggal_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tanggal' ,'required','onchange'=>"tgl();"])}}
                                    </div>
                                </div>
                                <div class="col-md-2">
                    ...
                    <center><kbd>EDIT FORM</kbd></center><br>
                            <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        {{ Form::label('tanggal_spb', 'Tanggal SPB:') }}
                                        {{ Form::date('tanggal_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tanggal2' ,'required','onchange'=>"tgl2();"])}}
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('tanggal_spb', 'Tanggal SPB:') }}
                                    {{ Form::date('tanggal_spb', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'tanggal3' ,'required','onchange'=>"tgl();",'readonly'])}}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('tanggal_kembali', 'Tanggal Kembali SPB:') }}
                                    {{ Form::date('tanggal_kembali', null,['class'=> 'form-control','id'=>'kembali3' ,'required','onchange'=>"tgl();"])}}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('kode_mobil',$Mobil->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'kode_mobil3','required','onchange'=>"getaset();"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
