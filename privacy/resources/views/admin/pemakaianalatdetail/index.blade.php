        ...
        <div class="box-body">
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                    ...
                    <!--        {{ Form::select('kode_alat', $Alat->sort(), null, ['class'=> 'form-control select2','id'=>'Alat1','required','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>'']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Sats', 'No SPK:') }}
                            {{ Form::select('no_spk', $Spk->sort(), null, ['class'=> 'form-control select2','id'=>'NoSpk1','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>'','onchange'=>'cekspk()']) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Sats', 'Kode Aset Alat:') }}
                             {{ Form::select('kode_alat', $Alat->sort(), null, ['class'=> 'form-control select2','id'=>'Alat1','required','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>'']) }} 
                            <!--{{ Form::hidden('kode_alat', null, ['class'=> 'form-control','id'=>'Alat1','readonly']) }}-->
                            <!--{{ Form::text('nama_alat',null, ['class'=> 'form-control','id'=>'NamaAlat1','autocomplete'=>'off','readonly']) }}-->
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {{ Form::text('no_timesheet',null, ['class'=> 'form-control','id'=>'NoTS1','autocomplete'=>'off','maxlength'=>'8']) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <!--        {{ Form::hidden('operator', null, ['class'=> 'form-control','id'=>'Operator1','readonly']) }}-->
                    <!--        {{ Form::text('nama_operator',null, ['class'=> 'form-control','id'=>'NamaOperator1','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--<div class="col-md-2">-->
                    <!--    <div class="form-group">-->
                    <!--        {{ Form::label('Sats', 'Helper 1:') }}-->
                    <!--        {{ Form::hidden('helper1', null, ['class'=> 'form-control','id'=>'Helper1a','readonly']) }}-->
                    <!--        {{ Form::text('nama_helper1',null, ['class'=> 'form-control','id'=>'NamaHelper1','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--<div class="col-md-2">-->
                    <!--    <div class="form-group">-->
                    <!--        {{ Form::label('Sats', 'Helper 2:') }}-->
                    <!--        {{ Form::hidden('helper2', null, ['class'=> 'form-control','id'=>'Helper1b','readonly']) }}-->
                    <!--        {{ Form::text('nama_helper2',null, ['class'=> 'form-control','id'=>'NamaHelper2','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--form add lama-->
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('Mobs', 'Pekerjaan:') }}&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
                            <b>
                            <input type="hidden" name="hari_libur" value="0" />
                            <input type="checkbox" name="hari_libur" id="Libur1" value="1"/>&nbsp;Hari Libur?</b>
                            {{ Form::textarea('pekerjaan',null, ['class'=> 'form-control','id'=>'Pekerjaan1','autocomplete'=>'off','rows'=>'2','onkeypress'=>"return pulsar(event,this)",'maxlength'=>'100']) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {{ Form::time('jam_dr', null,['class'=> 'form-control','id'=>'JamDr1' ,'required'])}}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Jams', 'Jam Sampai:') }}
                            {{ Form::time('jam_sp', null,['class'=> 'form-control','id'=>'JamSp1' ,'required'])}}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {{ Form::text('hm_dr',null, ['class'=> 'form-control','id'=>'HmDr1', 'onkeypress'=>"return hanyaAngka(event)"]) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('hmsampai', 'HM Sampai:') }}
                            {{ Form::text('hm_sp',null, ['class'=> 'form-control','id'=>'HmSp1', 'onkeypress'=>"return hanyaAngka(event)"]) }}
                        </div>
                    </div>
                </div>
                <span class="pull-right">
            ...
            <center><kbd>EDIT FORM</kbd></center><br>
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Sats', 'No SPK:') }}
                            {{ Form::select('no_spk', $Spk->sort(), null, ['class'=> 'form-control select2','id'=>'NoSpk2','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>'','onchange'=>'cekspk2()']) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <!--    <div class="form-group">-->
                    <!--        {{ Form::label('Sats', 'Kode Aset Alat:') }}-->
                    <!--        {{ Form::hidden('kode_alat', null, ['class'=> 'form-control','id'=>'Alat2','readonly']) }}-->
                    <!--        {{ Form::text('nama_alat',null, ['class'=> 'form-control','id'=>'NamaAlat2','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Mobs', 'No TimeSheet:') }}
                            {{ Form::text('no_timesheet',null, ['class'=> 'form-control','id'=>'NoTS2','autocomplete'=>'off','maxlength'=>'8']) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <!--    <div class="form-group">-->
                    <!--        {{ Form::label('Sats', 'Operator:') }}-->
                    <!--        {{ Form::hidden('operator', null, ['class'=> 'form-control','id'=>'Operator2','readonly']) }}-->
                    <!--        {{ Form::text('nama_operator',null, ['class'=> 'form-control','id'=>'NamaOperator2','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--<div class="col-md-2">-->
                    <!--    <div class="form-group">-->
                    <!--        {{ Form::label('Sats', 'Helper 1:') }}-->
                    <!--        {{ Form::hidden('helper1', null, ['class'=> 'form-control','id'=>'Helper2a','readonly']) }}-->
                    <!--        {{ Form::text('nama_helper1',null, ['class'=> 'form-control','id'=>'NamaHelper1e','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--<div class="col-md-2">-->
                    <!--    <div class="form-group">-->
                    <!--        {{ Form::label('Sats', 'Helper 2:') }}-->
                    <!--        {{ Form::hidden('helper2', null, ['class'=> 'form-control','id'=>'Helper2b','readonly']) }}-->
                    <!--        {{ Form::text('nama_helper1',null, ['class'=> 'form-control','id'=>'NamaHelper2e','autocomplete'=>'off','readonly']) }}-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--form edit lama-->
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Jams', 'Jam Breakdown:') }}
                            {{ Form::time('jam_breakdown', null,['class'=> 'form-control','id'=>'JamBr2'])}}
                        </div>
                    </div>
                    <div class="col-md-12"></div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Jams', 'Jam Dari:') }}
                            {{ Form::time('jam_dr', null,['class'=> 'form-control','id'=>'JamDr2' ,'required'])}}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('Jams', 'Jam Sampai:') }}
                            {{ Form::time('jam_sp', null,['class'=> 'form-control','id'=>'JamSp2' ,'required'])}}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('hmdari', 'HM Dari:') }}
                            {{ Form::text('hm_dr',null, ['class'=> 'form-control','id'=>'HmDr2', 'onkeypress'=>"return hanyaAngka(event)"]) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('hmsampai', 'HM Sampai:') }}
                            {{ Form::text('hm_sp',null, ['class'=> 'form-control','id'=>'HmSp2', 'onkeypress'=>"return hanyaAngka(event)"]) }}
                        </div>
                    </div>
                </div>
                <div class="row-md-2">
...
@push('js')
    <script>
        ...
        function cekspk(){
            ...
            $.ajax({
                url: '{!! route('pemakaianalatdetail.cekspk') !!}',
                type: 'POST',
                data : {
                    'no_spk': no_spk,
                },
        ...
        function cekspk2(){
            ...
            var id = $('#ID').val();
            $.ajax({
                url: '{!! route('pemakaianalatdetail.cekspk2') !!}',
                type: 'POST',
                data : {
                    'no_spk': no_spk,
                    'id': id,
