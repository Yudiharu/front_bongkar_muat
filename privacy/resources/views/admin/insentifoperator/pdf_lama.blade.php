        ...
        <table class="grid" style="font-size: 9pt; width: 1000px;" border="0" >
            ...
            <?php foreach ($insoperatordetail as $key => $row): ?>
                ...
                <?php $alatdetail = PemakaianAlatDetail::where('no_timesheet', $row->no_timesheet)->first(); ?>
                    <th style="text-align: left; width: 260px; word-spacing: -1px; font-weight: normal;"><?php echo $alatdetail->pekerjaan; ?></th>

                <?php if ($row->jam_dr == null) { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo substr($row->jam_dr, 0,5); ?></th>
                <?php } ?>

                <?php if ($row->jam_sp == null) { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo substr($row->jam_sp, 0,5); ?></th>
                <?php } ?>

                <?php if ($row->istirahat == null) { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo substr($row->istirahat, 0,5); ?></th>
                <?php } ?>

                <?php if ($row->stand_by == null) { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo "00:00"; ?></th>
                <?php }else { ?>
                    <th style="text-align: left; width: 45px; font-weight: normal;"><?php echo substr($row->stand_by, 0,5); ?></th>
                <?php } ?>
                ...
                <?php $alat = Alat::find($alatdetail->kode_alat); ?>
                    <th style="text-align: right; width: 130px; word-spacing: -1px; font-weight: normal;"><?php echo $alat->type; ?></th>
                </tr>
            <?php endforeach ?>
            </thead>
        </table>
    ...
    <div class="footer" style="font-size: 10pt;padding-top: 2cm; padding-left: 12px">
        ...
        <table width="100%" style="font-size:10pt; text-align:center;padding:0px; margin:0px; border-collapse:collapse" border="0">
            ...
            <tr style="padding:0px; margin:0px">
                ...
                <td><?php echo 'DHANU' ?></td>
                <td><?php echo $ttd6->mengetahui; ?></td>
                <td><?php echo 'MARCHENDRO' ?></td>
                <td><?php echo $ttd3; ?></td>
            </tr>
            <tr style="padding:0px; margin:0px">
                <td></td>
