...
<br><br>
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}"><font style="color: black; text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #FBBC5C, 0 0 40px #FBBC5C, 0 0 50px #FBBC5C, 0 0 60px #FBBC5C, 0 0 70px #FBBC5C;"><b>GUI Front System</b></font></a>
        </div>
        <!-- /.login-logo -->
