...
Route::middleware(['auth'])->prefix('admin')->group(function () {
     ...
     * Type JO
     */
    Route::get('typejo/anydata', 'TypeJOController@anyData')->name('typejo.data');
    Route::post('typejo/updateAjax', 'TypeJOController@updateAjax')->name('typejo.ajaxupdate');
    Route::post('typejo/hapus_transaksisetup', 'TypeJOController@hapus_transaksisetup')->name('typejo.hapus_transaksisetup');
    Route::post('typejo/edit_transaksisetup', 'TypeJOController@edit_transaksisetup')->name('typejo.edit_transaksisetup');
    Route::resource('typejo', 'TypeJOController');
    ...
    //  * Laporan Rekap Alat
    //  */
    Route::get('laporanrekapalat/exportpdf','LaporanrekapalatController@exportPDF')->name('laporanrekapalat.export');
    Route::resource('laporanrekapalat', 'LaporanrekapalatController');
    
    //**
    //  * Laporan Rekap Time Sheet
    //  */
    Route::get('laporanrekapts/exportpdf','LaporanrekaptsController@exportPDF')->name('laporanrekapts.export');
    Route::resource('laporanrekapts', 'LaporanrekaptsController');
    ...
    Route::get('joborder/historia', 'JoborderController@historia')->name('joborder.historia');
    ...
    Route::get('joborder/{joborder}/detail3', 'JoborderController@detail3')->name('joborder.detail3');
     ...
     * SPK
     */
    Route::get('spk/getDatajor', 'SpkController@getDatajor')->name('spk.getDatajor');
    Route::get('spk/exportpdf','SpkController@exportPDF')->name('spk.export');
    Route::post('spk/tarif', 'SpkController@tarif')->name('spk.tarif');
    Route::post('spk/edit_jobrequest', 'SpkController@edit_jobrequest')->name('spk.edit_jobrequest');
    Route::post('spk/hapus_jobrequest', 'SpkController@hapus_jobrequest')->name('spk.hapus_jobrequest');
    Route::post('spk/store2', 'SpkController@store2')->name('spk.store2');
    Route::post('spk/store', 'SpkController@store')->name('spk.store');
    Route::post('spk/hapus_noreqjo', 'SpkController@hapus_noreqjo')->name('spk.hapus_noreqjo');
    Route::post('spk/edit_noreqjo', 'SpkController@edit_noreqjo')->name('spk.edit_noreqjo');
    Route::get('spk/getDatabyID', 'SpkController@getDatabyID')->name('spk.dataDetail');
    Route::post('spk/updateAjax', 'SpkController@updateAjax')->name('spk.updateajax');
    Route::post('spk/showdetailjobreq', 'SpkController@Showdetailjobreq')->name('spk.showdetailjobreq');
    ...
    Route::get('pemakaianalat/historia', 'PemakaianAlatController@historia')->name('pemakaianalat.historia');
    ...
    Route::post('pemakaianalatdetail/cekspk2', 'PemakaianAlatDetailController@cekspk2')->name('pemakaianalatdetail.cekspk2');
    Route::post('pemakaianalatdetail/cekspk', 'PemakaianAlatDetailController@cekspk')->name('pemakaianalatdetail.cekspk');
    ...
    Route::get('insentifoperator/historia', 'InsentifoperatorController@historia')->name('insentifoperator.historia');
    ...
    Route::get('insentifhelper/historia', 'InsentifhelperController@historia')->name('insentifhelper.historia');
